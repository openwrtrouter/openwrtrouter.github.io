...
TNode<String> AllocateSeqOneByteString_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length) {
  ...
  TNode<IntPtrT> tmp13;
  TNode<IntPtrT> tmp14;
  TNode<SeqOneByteString> tmp15;
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp3 = kOneByteStringMap_0(state_);
    tmp4 = CodeStubAssembler(state_).Signed(TNode<Uint32T>{p_length});
    tmp5 = Convert_intptr_int32_0(state_, TNode<Int32T>{tmp4});
    tmp6 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp7 = AddIndexedFieldSizeToObjectSize_0(state_, TNode<IntPtrT>{tmp6}, TNode<IntPtrT>{tmp5}, kUInt8Size);
    tmp8 = AlignTagged_0(state_, TNode<IntPtrT>{tmp7});
    tmp9 = Allocate_0(state_, TNode<IntPtrT>{tmp8}, TNode<Map>{tmp3});
    ...
    tmp12 = FromConstexpr_uint32_constexpr_uint32_0(state_, Name::kEmptyHashField);
    CodeStubAssembler(state_).StoreReference<Uint32T>(CodeStubAssembler::Reference{tmp9, tmp11}, tmp12);
    tmp13 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    CodeStubAssembler(state_).StoreReference<Int32T>(CodeStubAssembler::Reference{tmp9, tmp13}, tmp4);
    tmp14 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    InitializeFieldsFromIterator_char8_UninitializedIterator_0(state_, TorqueStructSlice_char8_0{TNode<HeapObject>{tmp9}, TNode<IntPtrT>{tmp14}, TNode<IntPtrT>{tmp5}, TorqueStructUnsafe_0{}}, TorqueStructUninitializedIterator_0{});
    tmp15 = TORQUE_CAST(TNode<HeapObject>{tmp9});
...
TNode<String> AllocateSeqTwoByteString_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length) {
  ...
  if (block7.is_used()) {
    ...
    tmp5 = Convert_intptr_int32_0(state_, TNode<Int32T>{tmp4});
    tmp6 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp7 = AddIndexedFieldSizeToObjectSize_0(state_, TNode<IntPtrT>{tmp6}, TNode<IntPtrT>{tmp5}, kUInt16Size);
    tmp8 = AlignTagged_0(state_, TNode<IntPtrT>{tmp7});
    tmp9 = Allocate_0(state_, TNode<IntPtrT>{tmp8}, TNode<Map>{tmp3});
    tmp10 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    CodeStubAssembler(state_).StoreReference<Map>(CodeStubAssembler::Reference{tmp9, tmp10}, tmp3);
    ...
    CodeStubAssembler(state_).StoreReference<Int32T>(CodeStubAssembler::Reference{tmp9, tmp13}, tmp4);
    tmp14 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    InitializeFieldsFromIterator_char16_UninitializedIterator_0(state_, TorqueStructSlice_char16_0{TNode<HeapObject>{tmp9}, TNode<IntPtrT>{tmp14}, TNode<IntPtrT>{tmp5}, TorqueStructUnsafe_0{}}, TorqueStructUninitializedIterator_0{});
    tmp15 = TORQUE_CAST(TNode<HeapObject>{tmp9});
    ca_.Goto(&block1, tmp15);
  }
