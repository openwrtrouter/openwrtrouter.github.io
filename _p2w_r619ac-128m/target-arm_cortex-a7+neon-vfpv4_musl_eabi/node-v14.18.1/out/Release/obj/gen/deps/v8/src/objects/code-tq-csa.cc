...
TNode<Int8T> LoadBytecodeArrayOsrNestingLevel_0(compiler::CodeAssemblerState* state_, TNode<BytecodeArray> p_o) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).LoadReference<Int8T>(CodeStubAssembler::Reference{p_o, tmp0});
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TNode<Int8T>{tmp1};
}
...
void StoreBytecodeArrayOsrNestingLevel_0(compiler::CodeAssemblerState* state_, TNode<BytecodeArray> p_o, TNode<Int8T> p_v) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 32);
    CodeStubAssembler(state_).StoreReference<Int8T>(CodeStubAssembler::Reference{p_o, tmp0}, p_v);
    ca_.Goto(&block2);
  }
...
TNode<Int8T> LoadBytecodeArrayBytecodeAge_0(compiler::CodeAssemblerState* state_, TNode<BytecodeArray> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 33);
    tmp1 = CodeStubAssembler(state_).LoadReference<Int8T>(CodeStubAssembler::Reference{p_o, tmp0});
    ca_.Goto(&block2);
  }
