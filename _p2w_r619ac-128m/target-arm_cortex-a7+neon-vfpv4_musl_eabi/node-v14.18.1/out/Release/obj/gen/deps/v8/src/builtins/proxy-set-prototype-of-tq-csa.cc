...
TF_BUILTIN(ProxySetPrototypeOf, CodeStubAssembler) {
  ...
  if (block24.is_used()) {
    ...
    ca_.Branch(tmp9, &block40, std::vector<Node*>{}, &block41, std::vector<Node*>{});
  }
  ...
  if (block23.is_used()) {
    ...
    ca_.Branch(tmp12, &block25, std::vector<Node*>{}, &block26, std::vector<Node*>{});
  }
  ...
  if (block25.is_used()) {
    ...
    ca_.Branch(tmp14, &block27, std::vector<Node*>{}, &block28, std::vector<Node*>{});
  }
  ...
  if (block26.is_used()) {
    ...
    ca_.Branch(tmp18, &block36, std::vector<Node*>{}, &block37, std::vector<Node*>{});
  }
  ...
  if (block37.is_used()) {
    ...
    ca_.Branch(tmp21, &block38, std::vector<Node*>{}, &block39, std::vector<Node*>{});
  }
