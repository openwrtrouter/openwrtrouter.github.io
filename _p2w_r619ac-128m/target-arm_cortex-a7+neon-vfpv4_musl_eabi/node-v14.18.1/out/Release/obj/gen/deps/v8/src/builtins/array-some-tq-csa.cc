...
USE(parameter1);
  ...
  if (block15.is_used()) {
    ...
    tmp10 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArraySomeLoopContinuation, parameter0, tmp0, tmp2, parameter3, tmp8, tmp0, tmp4, tmp6, tmp9);
...
USE(parameter1);
  ...
  if (block18.is_used()) {
    ...
    tmp11 = CodeStubAssembler(state_).NumberAdd(TNode<Number>{tmp4}, TNode<Number>{tmp10});
    tmp12 = Undefined_0(state_);
    tmp13 = Undefined_0(state_);
    tmp14 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArraySomeLoopContinuation, parameter0, tmp0, tmp2, parameter3, tmp12, tmp0, tmp11, tmp6, tmp13);
...
TF_BUILTIN(ArraySomeLoopContinuation, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    ca_.Branch(tmp6, &block7, std::vector<Node*>{phi_bb5_9}, &block8, std::vector<Node*>{phi_bb5_9});
  }
  ...
  if (block6.is_used()) {
    ...
    tmp9 = CodeStubAssembler(state_).NumberAdd(TNode<Number>{phi_bb6_9}, TNode<Number>{tmp8});
...
TNode<Object> FastArraySome_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block27.is_used()) {
    ...
    ca_.Branch(tmp24, &block36, std::vector<Node*>{phi_bb27_5}, &block37, std::vector<Node*>{phi_bb27_5});
  }
  ...
  if (block14.is_used()) {
    ...
    tmp27 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{phi_bb14_5}, TNode<Smi>{tmp26});
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = RequireObjectCoercible_0(state_, TNode<Context>{parameter0}, TNode<Object>{parameter1}, "Array.prototype.some");
  ...
  if (block5.is_used()) {
    ...
    tmp11 = FastArraySome_0(state_, TNode<Context>{parameter0}, TNode<JSReceiver>{tmp1}, TNode<Number>{tmp2}, TNode<JSReceiver>{tmp7}, TNode<Object>{tmp10}, &label12, &tmp13);
    ca_.Goto(&block9);
    if (label12.is_used()) {
      ca_.Bind(&label12);
      ca_.Goto(&block10);
  ...
  if (block10.is_used()) {
    ...
    tmp16 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArraySomeLoopContinuation, parameter0, tmp1, tmp7, tmp10, tmp14, tmp1, tmp13.value(), tmp2, tmp15);
