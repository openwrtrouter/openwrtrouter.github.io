...
TF_BUILTIN(ProxyRevoke, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_ContextSlot_constexpr_ContextSlot_0(state_, Context::MIN_CONTEXT_SLOTS);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp5 = Null_0(state_);
    tmp6 = FromConstexpr_ContextSlot_constexpr_ContextSlot_0(state_, Context::MIN_CONTEXT_SLOTS);
    CodeStubAssembler(state_).StoreContextElement(TNode<Context>{parameter0}, TNode<IntPtrT>{tmp6}, TNode<Object>{tmp5});
    tmp7 = UnsafeCast_JSProxy_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp1});
    tmp8 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp9 = Null_0(state_);
    CodeStubAssembler(state_).StoreReference<HeapObject>(CodeStubAssembler::Reference{tmp7, tmp8}, tmp9);
    tmp10 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp11 = Null_0(state_);
    CodeStubAssembler(state_).StoreReference<HeapObject>(CodeStubAssembler::Reference{tmp7, tmp10}, tmp11);
    tmp12 = Undefined_0(state_);
    CodeStubAssembler(state_).Return(tmp12);
  }
}

TNode<JSProxy> UnsafeCast_JSProxy_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
