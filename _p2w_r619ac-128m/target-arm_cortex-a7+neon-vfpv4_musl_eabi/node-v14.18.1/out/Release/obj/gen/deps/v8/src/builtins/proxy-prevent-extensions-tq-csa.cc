...
TF_BUILTIN(ProxyPreventExtensions, CodeStubAssembler) {
  ...
  if (block17.is_used()) {
    ...
    ca_.Branch(tmp9, &block32, std::vector<Node*>{}, &block33, std::vector<Node*>{});
  }
  ...
  if (block16.is_used()) {
    ...
    ca_.Branch(tmp11, &block18, std::vector<Node*>{}, &block19, std::vector<Node*>{});
  }
  ...
  if (block18.is_used()) {
    ...
    ca_.Branch(tmp14, &block28, std::vector<Node*>{}, &block29, std::vector<Node*>{});
  }
  ...
  if (block19.is_used()) {
    ...
    ca_.Branch(tmp17, &block30, std::vector<Node*>{}, &block31, std::vector<Node*>{});
  }
