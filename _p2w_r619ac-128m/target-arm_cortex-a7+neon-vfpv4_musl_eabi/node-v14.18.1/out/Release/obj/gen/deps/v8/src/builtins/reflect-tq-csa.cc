...
TF_BUILTIN(ReflectSetPrototypeOf, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{parameter0}, MessageTemplate::kCalledOnNonObject, "Reflect.setPrototypeOf");
  }
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp4 = ObjectSetPrototypeOfDontThrow_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp0}, TNode<HeapObject>{tmp2});
...
TF_BUILTIN(ReflectGet, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{parameter0}, MessageTemplate::kCalledOnNonObject, "Reflect.get");
  }
  ...
  if (block3.is_used()) {
    ...
    tmp6 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kToName, parameter0, tmp5));
    tmp7 = FromConstexpr_intptr_constexpr_int31_0(state_, 2);
  ...
  if (block7.is_used()) {
    ...
    tmp12 = CodeStubAssembler(state_).CallBuiltin(Builtins::kGetPropertyWithReceiver, parameter0, tmp2, tmp6, phi_bb7_8, tmp11);
...
TF_BUILTIN(ReflectDeleteProperty, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{parameter0}, MessageTemplate::kCalledOnNonObject, "Reflect.deleteProperty");
  }
  ...
  if (block3.is_used()) {
    ...
    tmp3 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kDeleteProperty, parameter0, tmp0, parameter2, tmp2));
...
TF_BUILTIN(ReflectHas, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp2 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kHasProperty, parameter0, tmp0, parameter2));
    CodeStubAssembler(state_).Return(tmp2);
  }
}
