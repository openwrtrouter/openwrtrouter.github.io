...
TNode<Object> RegExpExec_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<String> p_string) {
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    tmp10 = CodeStubAssembler(state_).CallBuiltin(Builtins::kRegExpPrototypeExecSlow, p_context, tmp4, p_string);
...
TNode<RegExpMatchInfo> RegExpPrototypeExecBodyWithoutResult_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string, TNode<Number> p_regexpLastIndex, bool p_isFastPath, compiler::CodeAssemblerLabel* label_IfDidNotMatch) {
  ...
  if (block17.is_used()) {
    ...
    ca_.Branch(phi_bb17_9, &block13, std::vector<Node*>{}, &block14, std::vector<Node*>{});
  }
  ...
  if (block12.is_used()) {
    ...
    ca_.Branch(tmp20, &block18, std::vector<Node*>{phi_bb12_4}, &block19, std::vector<Node*>{phi_bb12_4});
  }
  ...
  if (block18.is_used()) {
    ...
    ca_.Branch(tmp9, &block20, std::vector<Node*>{phi_bb18_4}, &block21, std::vector<Node*>{phi_bb18_4});
  }
  ...
  if (block19.is_used()) {
    ...
    ca_.Branch(tmp9, &block22, std::vector<Node*>{phi_bb19_4}, &block23, std::vector<Node*>{phi_bb19_4});
  }
...
TNode<JSFunction> LoadRegExpFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_NativeContextSlot_constexpr_REGEXP_FUNCTION_INDEX_0(state_, Context::Field::REGEXP_FUNCTION_INDEX);
    tmp1 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{p_nativeContext}, TNode<IntPtrT>{tmp0});
    tmp2 = UnsafeCast_JSFunction_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp1});
    ca_.Goto(&block2);
  }
...
TNode<BoolT> HasInitialRegExpMap_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<HeapObject> p_o) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = LoadRegExpFunction_0(state_, TNode<Context>{p_context}, TNode<NativeContext>{tmp0});
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FlagGetter_0(state_, TNode<Context>{parameter0}, TNode<Object>{parameter1}, JSRegExp::Flag::kGlobal, v8::Isolate::kRegExpPrototypeOldFlagGetter, "RegExp.prototype.global");
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FlagGetter_0(state_, TNode<Context>{parameter0}, TNode<Object>{parameter1}, JSRegExp::Flag::kIgnoreCase, v8::Isolate::kRegExpPrototypeOldFlagGetter, "RegExp.prototype.ignoreCase");
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FlagGetter_0(state_, TNode<Context>{parameter0}, TNode<Object>{parameter1}, JSRegExp::Flag::kMultiline, v8::Isolate::kRegExpPrototypeOldFlagGetter, "RegExp.prototype.multiline");
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FlagGetter_0(state_, TNode<Context>{parameter0}, TNode<Object>{parameter1}, JSRegExp::Flag::kDotAll, -1, "RegExp.prototype.dotAll");
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
TNode<BoolT> IsRegExp_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_obj) {
  ...
  if (block7.is_used()) {
    ...
    ca_.Branch(tmp8, &block12, std::vector<Node*>{}, &block13, std::vector<Node*>{});
  }
  ...
  if (block13.is_used()) {
    ...
    ca_.Branch(tmp13, &block20, std::vector<Node*>{}, &block21, std::vector<Node*>{});
  }
...
TNode<Object> RegExpCreate_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<Object> p_maybeString, TNode<String> p_flags) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = LoadRegExpFunction_0(state_, TNode<Context>{p_context}, TNode<NativeContext>{p_nativeContext});
