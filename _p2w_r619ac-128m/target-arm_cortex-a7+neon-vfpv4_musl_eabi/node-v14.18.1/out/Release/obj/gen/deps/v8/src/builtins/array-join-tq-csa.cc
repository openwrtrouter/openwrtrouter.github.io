...
TF_BUILTIN(LoadJoinElement_FastSmiOrObjectElements_0, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp3, tmp6});
    tmp8 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp7});
    tmp9 = Convert_intptr_uintptr_0(state_, TNode<UintPtrT>{parameter2});
  ...
  if (block5.is_used()) {
    ...
    std::tie(tmp16, tmp17) = NewReference_Object_0(state_, TNode<HeapObject>{tmp3}, TNode<IntPtrT>{tmp15}).Flatten();
    ...
    ca_.Branch(tmp20, &block8, std::vector<Node*>{}, &block9, std::vector<Node*>{});
  }
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    tmp22 = UnsafeCast_JSAny_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp18});
...
TF_BUILTIN(LoadJoinElement_FastDoubleElements_0, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp11 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp8});
    tmp12 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp10}, TNode<UintPtrT>{tmp11});
    ca_.Branch(tmp12, &block7, std::vector<Node*>{}, &block8, std::vector<Node*>{});
  }
  ...
  if (block7.is_used()) {
    ...
    tmp14 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp9}, TNode<IntPtrT>{tmp13});
    tmp15 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp4}, TNode<IntPtrT>{tmp14});
    std::tie(tmp16, tmp17) = NewReference_float64_or_hole_0(state_, TNode<HeapObject>{tmp3}, TNode<IntPtrT>{tmp15}).Flatten();
    ...
    ca_.Branch(tmp18, &block11, std::vector<Node*>{}, &block12, std::vector<Node*>{});
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    tmp21 = CodeStubAssembler(state_).AllocateHeapNumberWithValue(TNode<Float64T>{tmp19});
...
TNode<BoolT> CannotUseSameArrayAccessor_JSArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BuiltinPtr> p_loadFn, TNode<JSReceiver> p_receiver, TNode<Map> p_originalMap, TNode<Number> p_originalLen) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).SmiEqual(TNode<Smi>{p_loadFn}, TNode<Smi>{ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinElement_GenericElementsAccessor_0))});
...
TNode<String> BufferJoin_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructBuffer_0 p_buffer, TNode<String> p_sep) {
  ...
  if (block8.is_used()) {
    ...
    tmp8 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{p_buffer.fixedArray, tmp7});
  ...
  if (block14.is_used()) {
    ...
    std::tie(tmp17, tmp18) = NewReference_Object_0(state_, TNode<HeapObject>{p_buffer.fixedArray}, TNode<IntPtrT>{tmp16}).Flatten();
  ...
  if (block20.is_used()) {
    ...
    tmp22 = Cast_Number_0(state_, TNode<Object>{ca_.UncheckedCast<Object>(tmp19)}, &label23);
    ca_.Goto(&block23);
    if (label23.is_used()) {
      ca_.Bind(&label23);
      ca_.Goto(&block24);
  ...
  if (block23.is_used()) {
    ca_.Bind(&block23);
    tmp24 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kStringRepeat, p_context, p_sep, tmp22));
  ...
  if (block9.is_used()) {
    ...
    ca_.Branch(p_buffer.isOneByte, &block25, std::vector<Node*>{}, &block26, std::vector<Node*>{});
  }
  ...
  if (block27.is_used()) {
    ...
    tmp29 = ArrayBuiltinsAssembler(state_).CallJSArrayArrayJoinConcatToSequentialString(TNode<FixedArray>{p_buffer.fixedArray}, TNode<IntPtrT>{p_buffer.index}, TNode<String>{p_sep}, TNode<String>{phi_bb27_7});
...
TNode<Object> ArrayJoin_JSArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_useToLocaleString, TNode<JSReceiver> p_receiver, TNode<String> p_sep, TNode<Number> p_lenNumber, TNode<Object> p_locales, TNode<Object> p_options) {
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.Goto(&block14, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinElement_FastSmiOrObjectElements_0)));
  }
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    ca_.Goto(&block17, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinElement_FastDoubleElements_0)));
  }
  ...
  if (block16.is_used()) {
    ...
    ca_.Branch(tmp14, &block18, std::vector<Node*>{}, &block19, std::vector<Node*>{});
  }
  ...
  if (block21.is_used()) {
    ...
    ca_.Branch(tmp22, &block24, std::vector<Node*>{}, &block25, std::vector<Node*>{});
  }
  ...
  if (block28.is_used()) {
    ca_.Bind(&block28);
    tmp28 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kStringRepeat, p_context, p_sep, tmp26));
    ca_.Goto(&block1, tmp28);
  }

  if (block22.is_used()) {
    ca_.Bind(&block22);
    ca_.Goto(&block17, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinElement_DictionaryElements_0)));
  }
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.Goto(&block2, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinElement_GenericElementsAccessor_0)));
  }
...
TNode<Object> ArrayJoin_JSTypedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_useToLocaleString, TNode<JSReceiver> p_receiver, TNode<String> p_sep, TNode<Number> p_lenNumber, TNode<Object> p_locales, TNode<Object> p_options) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.Goto(&block7, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinTypedElement_Int32Elements_0)));
  }
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.Goto(&block10, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinTypedElement_Float32Elements_0)));
  }
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    ca_.Goto(&block13, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinTypedElement_Float64Elements_0)));
  }
  ...
  if (block12.is_used()) {
    ...
    ca_.Branch(tmp11, &block14, std::vector<Node*>{}, &block15, std::vector<Node*>{});
  }

  if (block14.is_used()) {
    ca_.Bind(&block14);
    ca_.Goto(&block16, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinTypedElement_Uint8ClampedElements_0)));
  }
  ...
  if (block15.is_used()) {
    ...
    ca_.Branch(tmp13, &block17, std::vector<Node*>{}, &block18, std::vector<Node*>{});
  }

  if (block17.is_used()) {
    ca_.Bind(&block17);
    ca_.Goto(&block19, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinTypedElement_BigUint64Elements_0)));
  }
  ...
  if (block18.is_used()) {
    ...
    ca_.Branch(tmp15, &block20, std::vector<Node*>{}, &block21, std::vector<Node*>{});
  }

  if (block20.is_used()) {
    ca_.Bind(&block20);
    ca_.Goto(&block19, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinTypedElement_BigInt64Elements_0)));
  }
  ...
  if (block23.is_used()) {
    ca_.Bind(&block23);
    ca_.Goto(&block25, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinTypedElement_Uint8Elements_0)));
  }
  ...
  if (block24.is_used()) {
    ...
    ca_.Branch(tmp19, &block26, std::vector<Node*>{}, &block27, std::vector<Node*>{});
  }

  if (block26.is_used()) {
    ca_.Bind(&block26);
    ca_.Goto(&block28, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinTypedElement_Int8Elements_0)));
  }
  ...
  if (block27.is_used()) {
    ...
    ca_.Branch(tmp21, &block29, std::vector<Node*>{}, &block30, std::vector<Node*>{});
  }

  if (block29.is_used()) {
    ca_.Bind(&block29);
    ca_.Goto(&block31, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinTypedElement_Uint16Elements_0)));
  }
  ...
  if (block30.is_used()) {
    ...
    ca_.Branch(tmp23, &block32, std::vector<Node*>{}, &block33, std::vector<Node*>{});
  }

  if (block32.is_used()) {
    ca_.Bind(&block32);
    ca_.Goto(&block34, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinTypedElement_Int16Elements_0)));
  }
  ...
  if (block33.is_used()) {
    ...
    ca_.Branch(tmp25, &block35, std::vector<Node*>{}, &block36, std::vector<Node*>{});
  }

  if (block35.is_used()) {
    ca_.Bind(&block35);
    ca_.Goto(&block34, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinTypedElement_Uint32Elements_0)));
  }
...
TNode<FixedArray> LoadJoinStack_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, compiler::CodeAssemblerLabel* label_IfUninitialized) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = FromConstexpr_NativeContextSlot_constexpr_ARRAY_JOIN_STACK_INDEX_0(state_, Context::Field::ARRAY_JOIN_STACK_INDEX);
    tmp2 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp0}, TNode<IntPtrT>{tmp1});
    tmp3 = UnsafeCast_HeapObject_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp2});
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp6 = UnsafeCast_FixedArray_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp3});
    ca_.Goto(&block9);
  }
...
void SetJoinStack_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_stack) {
  ...
  if (block0.is_used()) {
    ...
    tmp0 = CodeStubAssembler(state_).LoadNativeContext(TNode<Context>{p_context});
    tmp1 = FromConstexpr_NativeContextSlot_constexpr_ARRAY_JOIN_STACK_INDEX_0(state_, Context::Field::ARRAY_JOIN_STACK_INDEX);
    CodeStubAssembler(state_).StoreContextElement(TNode<NativeContext>{tmp0}, TNode<IntPtrT>{tmp1}, TNode<Object>{p_stack});
    ca_.Goto(&block2);
  }
...
TF_BUILTIN(JoinStackPush, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp2, &block1, std::vector<Node*>{phi_bb3_4}, &block2, std::vector<Node*>{phi_bb3_4});
  }
  ...
  if (block1.is_used()) {
    ...
    tmp8 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{phi_bb1_4});
    ...
    ca_.Branch(tmp10, &block9, std::vector<Node*>{phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4}, &block10, std::vector<Node*>{phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4});
  }
  ...
  if (block9.is_used()) {
    ...
    tmp12 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{phi_bb9_15}, TNode<IntPtrT>{tmp11});
    tmp13 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp3}, TNode<IntPtrT>{tmp12});
    std::tie(tmp14, tmp15) = NewReference_Object_0(state_, TNode<HeapObject>{parameter1}, TNode<IntPtrT>{tmp13}).Flatten();
    ...
    ca_.Branch(tmp18, &block12, std::vector<Node*>{phi_bb9_4}, &block13, std::vector<Node*>{phi_bb9_4});
  }
  ...
  if (block12.is_used()) {
    ...
    tmp22 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{parameter1, tmp21});
    tmp23 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp22});
    tmp24 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{phi_bb12_4});
    ...
    ca_.Branch(tmp26, &block18, std::vector<Node*>{phi_bb12_4, phi_bb12_4, phi_bb12_4, phi_bb12_4, phi_bb12_4}, &block19, std::vector<Node*>{phi_bb12_4, phi_bb12_4, phi_bb12_4, phi_bb12_4, phi_bb12_4});
  }
  ...
  if (block18.is_used()) {
    ...
    tmp28 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{phi_bb18_16}, TNode<IntPtrT>{tmp27});
    tmp29 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp19}, TNode<IntPtrT>{tmp28});
    std::tie(tmp30, tmp31) = NewReference_Object_0(state_, TNode<HeapObject>{parameter1}, TNode<IntPtrT>{tmp29}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp30, tmp31}, parameter2);
    tmp32 = True_0(state_);
  ...
  if (block13.is_used()) {
    ...
    tmp33 = CodeStubAssembler(state_).TaggedEqual(TNode<HeapObject>{parameter2}, TNode<Object>{tmp16});
    ca_.Branch(tmp33, &block21, std::vector<Node*>{phi_bb13_4}, &block22, std::vector<Node*>{phi_bb13_4});
  }
  ...
  if (block22.is_used()) {
    ...
    tmp36 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb22_4}, TNode<IntPtrT>{tmp35});
    ca_.Goto(&block3, tmp36);
  }
  ...
  if (block2.is_used()) {
    ...
    tmp37 = StoreAndGrowFixedArray_JSReceiver_0(state_, TNode<FixedArray>{parameter1}, TNode<IntPtrT>{tmp0}, TNode<JSReceiver>{parameter2});
    SetJoinStack_0(state_, TNode<Context>{parameter0}, TNode<FixedArray>{tmp37});
    tmp38 = True_0(state_);
...
TNode<BoolT> JoinStackPushInline_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver) {
  ...
  if (block5.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp3, tmp6});
    tmp8 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp7});
    tmp9 = Convert_intptr_constexpr_int31_0(state_, 0);
    tmp10 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp9});
    tmp11 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp8});
    tmp12 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp10}, TNode<UintPtrT>{tmp11});
    ca_.Branch(tmp12, &block29, std::vector<Node*>{}, &block30, std::vector<Node*>{});
  }
  ...
  if (block4.is_used()) {
    ...
    tmp16 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp0, tmp15});
    tmp17 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp16});
    tmp18 = Convert_intptr_constexpr_int31_0(state_, 0);
    ...
    ca_.Branch(tmp21, &block12, std::vector<Node*>{}, &block13, std::vector<Node*>{});
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    tmp22 = FromConstexpr_intptr_constexpr_int31_0(state_, kTaggedSize);
    tmp23 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp18}, TNode<IntPtrT>{tmp22});
    tmp24 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp13}, TNode<IntPtrT>{tmp23});
    std::tie(tmp25, tmp26) = NewReference_Object_0(state_, TNode<HeapObject>{tmp0}, TNode<IntPtrT>{tmp24}).Flatten();
    tmp27 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp25, tmp26});
    tmp28 = TheHole_0(state_);
    tmp29 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp27}, TNode<HeapObject>{tmp28});
    ca_.Branch(tmp29, &block6, std::vector<Node*>{}, &block7, std::vector<Node*>{});
  }
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp44 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kJoinStackPush, p_context, tmp0, p_receiver));
    tmp45 = False_0(state_);
    tmp46 = CodeStubAssembler(state_).TaggedEqual(TNode<HeapObject>{tmp44}, TNode<HeapObject>{tmp45});
    ca_.Branch(tmp46, &block23, std::vector<Node*>{}, &block24, std::vector<Node*>{});
  }
  ...
  if (block29.is_used()) {
    ...
    tmp49 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp9}, TNode<IntPtrT>{tmp48});
    tmp50 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp4}, TNode<IntPtrT>{tmp49});
    std::tie(tmp51, tmp52) = NewReference_Object_0(state_, TNode<HeapObject>{tmp3}, TNode<IntPtrT>{tmp50}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp51, tmp52}, p_receiver);
...
TF_BUILTIN(JoinStackPop, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    tmp9 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp7});
    tmp10 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp8}, TNode<UintPtrT>{tmp9});
    ca_.Branch(tmp10, &block11, std::vector<Node*>{phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4}, &block12, std::vector<Node*>{phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4});
  }
  ...
  if (block11.is_used()) {
    ...
    tmp11 = FromConstexpr_intptr_constexpr_int31_0(state_, kTaggedSize);
    tmp12 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{phi_bb11_15}, TNode<IntPtrT>{tmp11});
    tmp13 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp3}, TNode<IntPtrT>{tmp12});
    std::tie(tmp14, tmp15) = NewReference_Object_0(state_, TNode<HeapObject>{parameter1}, TNode<IntPtrT>{tmp13}).Flatten();
    tmp16 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp14, tmp15});
    tmp17 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp16}, TNode<HeapObject>{parameter2});
    ca_.Branch(tmp17, &block5, std::vector<Node*>{phi_bb11_4}, &block6, std::vector<Node*>{phi_bb11_4});
  }
  ...
  if (block5.is_used()) {
    ...
    tmp19 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{phi_bb5_4}, TNode<IntPtrT>{tmp18});
    ca_.Branch(tmp19, &block16, std::vector<Node*>{phi_bb5_4}, &block17, std::vector<Node*>{phi_bb5_4});
  }
  ...
  if (block16.is_used()) {
    ...
    tmp21 = CodeStubAssembler(state_).IntPtrGreaterThan(TNode<IntPtrT>{tmp0}, TNode<IntPtrT>{tmp20});
    ca_.Goto(&block18, phi_bb16_4, tmp21);
  }
  ...
  if (block17.is_used()) {
    ...
    ca_.Goto(&block18, phi_bb17_4, tmp22);
  }
  ...
  if (block18.is_used()) {
    ...
    ca_.Branch(phi_bb18_6, &block14, std::vector<Node*>{phi_bb18_4}, &block15, std::vector<Node*>{phi_bb18_4});
  }
  ...
  if (block14.is_used()) {
    ...
    tmp23 = FromConstexpr_intptr_constexpr_int31_0(state_, JSArray::kMinJoinStackSize);
    tmp24 = CodeStubAssembler(state_).AllocateFixedArrayWithHoles(TNode<IntPtrT>{tmp23}, CodeStubAssembler::AllocationFlag::kNone);
    SetJoinStack_0(state_, TNode<Context>{parameter0}, TNode<FixedArray>{tmp24});
  ...
  if (block15.is_used()) {
    ...
    tmp28 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{parameter1, tmp27});
    tmp29 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp28});
    tmp30 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{phi_bb15_4});
    ...
    ca_.Branch(tmp32, &block24, std::vector<Node*>{phi_bb15_4, phi_bb15_4, phi_bb15_4, phi_bb15_4, phi_bb15_4}, &block25, std::vector<Node*>{phi_bb15_4, phi_bb15_4, phi_bb15_4, phi_bb15_4, phi_bb15_4});
  }
  ...
  if (block24.is_used()) {
    ...
    tmp34 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{phi_bb24_15}, TNode<IntPtrT>{tmp33});
    tmp35 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp25}, TNode<IntPtrT>{tmp34});
    std::tie(tmp36, tmp37) = NewReference_Object_0(state_, TNode<HeapObject>{parameter1}, TNode<IntPtrT>{tmp35}).Flatten();
  ...
  if (block6.is_used()) {
    ...
    tmp41 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb6_4}, TNode<IntPtrT>{tmp40});
    ca_.Goto(&block3, tmp41);
  }
...
void JoinStackPopInline_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver) {
  ...
  if (block12.is_used()) {
    ...
    std::tie(tmp15, tmp16) = NewReference_Object_0(state_, TNode<HeapObject>{tmp0}, TNode<IntPtrT>{tmp14}).Flatten();
    tmp17 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp15, tmp16});
    tmp18 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp17}, TNode<HeapObject>{p_receiver});
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    tmp19 = FromConstexpr_intptr_constexpr_int31_0(state_, JSArray::kMinJoinStackSize);
    tmp20 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{tmp2}, TNode<IntPtrT>{tmp19});
  ...
  if (block16.is_used()) {
    ...
    ca_.Goto(&block17, tmp21);
  }

  TNode<BoolT> phi_bb17_5;
  if (block17.is_used()) {
    ca_.Bind(&block17, &phi_bb17_5);
    ca_.Branch(phi_bb17_5, &block6, std::vector<Node*>{}, &block7, std::vector<Node*>{});
  }
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).StoreFixedArrayElement(TNode<FixedArray>{tmp0}, 0, TNode<Object>{tmp22}, SKIP_WRITE_BARRIER);
    ca_.Goto(&block18);
  }
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp23 = CodeStubAssembler(state_).CallBuiltin(Builtins::kJoinStackPop, p_context, tmp0, p_receiver);
    ca_.Goto(&block18);
  }
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    tmp4 = FromConstexpr_Number_constexpr_uint32_0(state_, (CodeStubAssembler(state_).ConstexprUint32Add(JSArray::kMaxArrayIndex, 1)));
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    tmp6 = FromConstexpr_Number_constexpr_uint32_0(state_, (CodeStubAssembler(state_).ConstexprUint32Add(JSArray::kMaxArrayIndex, 1)));
...
USE(parameter1);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp5 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kObjectToString, parameter0, tmp0));
...
TNode<String> ArrayJoinImpl_JSArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<String> p_sep, TNode<Number> p_lengthNumber, bool p_useToLocaleString, TNode<Object> p_locales, TNode<Object> p_options, TNode<BuiltinPtr> p_initialLoadFn) {
  ...
  if (block4.is_used()) {
    ...
    ca_.Branch(tmp10, &block2, std::vector<Node*>{phi_bb4_10, phi_bb4_11, phi_bb4_12, phi_bb4_13, phi_bb4_14, phi_bb4_15, phi_bb4_16}, &block3, std::vector<Node*>{phi_bb4_10, phi_bb4_11, phi_bb4_12, phi_bb4_13, phi_bb4_14, phi_bb4_15, phi_bb4_16});
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.Branch(tmp11, &block5, std::vector<Node*>{phi_bb2_10, phi_bb2_11, phi_bb2_12, phi_bb2_13, phi_bb2_14, phi_bb2_15, phi_bb2_16}, &block6, std::vector<Node*>{phi_bb2_10, phi_bb2_11, phi_bb2_12, phi_bb2_13, phi_bb2_14, phi_bb2_15, phi_bb2_16});
  }
  ...
  if (block5.is_used()) {
    ...
    ca_.Goto(&block6, phi_bb5_10, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtins::kLoadJoinElement_GenericElementsAccessor_0)), phi_bb5_12, phi_bb5_13, phi_bb5_14, phi_bb5_15, phi_bb5_16);
  }
  ...
  if (block6.is_used()) {
    ...
    ca_.Branch(tmp13, &block7, std::vector<Node*>{phi_bb6_10, phi_bb6_12, phi_bb6_13, phi_bb6_14, phi_bb6_15, phi_bb6_16}, &block8, std::vector<Node*>{phi_bb6_10, phi_bb6_12, phi_bb6_13, phi_bb6_14, phi_bb6_15, phi_bb6_16});
  }
...
tmp18 = CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(0)).descriptor(), phi_bb6_11, p_context, p_receiver, phi_bb8_16);
  ...
  if (block9.is_used()) {
    ...
    tmp19 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kConvertToLocaleString, p_context, tmp18, p_locales, p_options));
    tmp20 = kEmptyString_0(state_);
    tmp21 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp19}, TNode<HeapObject>{tmp20});
    ca_.Branch(tmp21, &block12, std::vector<Node*>{phi_bb9_12, phi_bb9_13, phi_bb9_14, phi_bb9_15}, &block13, std::vector<Node*>{phi_bb9_12, phi_bb9_13, phi_bb9_14, phi_bb9_15});
  }
  ...
  if (block16.is_used()) {
    ...
    ca_.Branch(tmp27, &block18, std::vector<Node*>{phi_bb16_12, phi_bb16_13, phi_bb16_14, phi_bb16_15}, &block19, std::vector<Node*>{phi_bb16_12, phi_bb16_13, phi_bb16_14, phi_bb16_15});
  }
  ...
  if (block23.is_used()) {
    ...
    ca_.Branch(tmp28, &block24, std::vector<Node*>{phi_bb23_12, phi_bb23_13, phi_bb23_14, phi_bb23_15}, &block25, std::vector<Node*>{phi_bb23_12, phi_bb23_13, phi_bb23_14, phi_bb23_15});
  }
  ...
  if (block25.is_used()) {
    ...
    tmp30 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kToString, p_context, ca_.UncheckedCast<HeapObject>(tmp18)));
  ...
  if (block11.is_used()) {
    ...
    ca_.Branch(tmp37, &block30, std::vector<Node*>{phi_bb11_12, phi_bb11_13, phi_bb11_14, phi_bb11_15, phi_bb11_18, phi_bb11_18, phi_bb11_18}, &block31, std::vector<Node*>{phi_bb11_12, phi_bb11_13, phi_bb11_14, phi_bb11_15, phi_bb11_18, phi_bb11_18, phi_bb11_18});
  }
  ...
  if (block32.is_used()) {
    ...
    ca_.Branch(phi_bb32_37, &block28, std::vector<Node*>{phi_bb32_12, phi_bb32_13, phi_bb32_14, phi_bb32_15, phi_bb32_18, phi_bb32_19, phi_bb32_24}, &block29, std::vector<Node*>{phi_bb32_12, phi_bb32_13, phi_bb32_14, phi_bb32_15, phi_bb32_18, phi_bb32_19, phi_bb32_24});
  }
  ...
  if (block29.is_used()) {
    ...
    ca_.Branch(tmp43, &block33, std::vector<Node*>{phi_bb29_12, phi_bb29_13, phi_bb29_14, phi_bb29_15, phi_bb29_18, phi_bb29_19, phi_bb29_24}, &block34, std::vector<Node*>{phi_bb29_12, phi_bb29_13, phi_bb29_14, phi_bb29_15, phi_bb29_18, phi_bb29_19, phi_bb29_24});
  }
  ...
  if (block34.is_used()) {
    ...
    ca_.Branch(tmp35, &block35, std::vector<Node*>{phi_bb34_12, phi_bb34_13, phi_bb34_15, phi_bb34_18, phi_bb34_19, phi_bb34_24}, &block36, std::vector<Node*>{phi_bb34_12, phi_bb34_13, phi_bb34_15, phi_bb34_18, phi_bb34_19, phi_bb34_24});
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp60, &block40, std::vector<Node*>{phi_bb3_10, phi_bb3_11, phi_bb3_12, phi_bb3_13, phi_bb3_14, phi_bb3_15, phi_bb3_16, phi_bb3_10, phi_bb3_10}, &block41, std::vector<Node*>{phi_bb3_10, phi_bb3_11, phi_bb3_12, phi_bb3_13, phi_bb3_14, phi_bb3_15, phi_bb3_16, phi_bb3_10, phi_bb3_10});
  }
  ...
  if (block42.is_used()) {
    ...
    ca_.Branch(phi_bb42_25, &block38, std::vector<Node*>{phi_bb42_10, phi_bb42_11, phi_bb42_12, phi_bb42_13, phi_bb42_14, phi_bb42_15, phi_bb42_16, phi_bb42_17, phi_bb42_21}, &block39, std::vector<Node*>{phi_bb42_10, phi_bb42_11, phi_bb42_12, phi_bb42_13, phi_bb42_14, phi_bb42_15, phi_bb42_16, phi_bb42_17, phi_bb42_21});
  }
  ...
  if (block39.is_used()) {
    ...
    ca_.Branch(tmp66, &block43, std::vector<Node*>{phi_bb39_10, phi_bb39_11, phi_bb39_12, phi_bb39_13, phi_bb39_14, phi_bb39_15, phi_bb39_16, phi_bb39_17, phi_bb39_21, phi_bb39_21}, &block44, std::vector<Node*>{phi_bb39_10, phi_bb39_11, phi_bb39_12, phi_bb39_13, phi_bb39_14, phi_bb39_15, phi_bb39_16, phi_bb39_17, phi_bb39_21, phi_bb39_21});
  }
  ...
  if (block44.is_used()) {
    ...
    ca_.Branch(tmp58, &block45, std::vector<Node*>{phi_bb44_10, phi_bb44_11, phi_bb44_12, phi_bb44_13, phi_bb44_15, phi_bb44_16, phi_bb44_17, phi_bb44_21, phi_bb44_24}, &block46, std::vector<Node*>{phi_bb44_10, phi_bb44_11, phi_bb44_12, phi_bb44_13, phi_bb44_15, phi_bb44_16, phi_bb44_17, phi_bb44_21, phi_bb44_24});
  }
...
TNode<FixedArray> StoreAndGrowFixedArray_JSReceiver_0(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_fixedArray, TNode<IntPtrT> p_index, TNode<JSReceiver> p_element) {
  ...
  if (block6.is_used()) {
    ...
    tmp5 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{p_fixedArray, tmp4});
    tmp6 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp5});
    tmp7 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{p_index});
  ...
  if (block13.is_used()) {
    ...
    tmp11 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{p_index}, TNode<IntPtrT>{tmp10});
    tmp12 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp2}, TNode<IntPtrT>{tmp11});
    std::tie(tmp13, tmp14) = NewReference_Object_0(state_, TNode<HeapObject>{p_fixedArray}, TNode<IntPtrT>{tmp12}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp13, tmp14}, p_element);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp15 = CodeStubAssembler(state_).CalculateNewElementsCapacity(TNode<IntPtrT>{tmp0});
    tmp16 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    tmp17 = ExtractFixedArray_0(state_, TNode<FixedArray>{p_fixedArray}, TNode<IntPtrT>{tmp16}, TNode<IntPtrT>{tmp0}, TNode<IntPtrT>{tmp15});
    ...
    tmp21 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp17, tmp20});
    tmp22 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp21});
    tmp23 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{p_index});
  ...
  if (block24.is_used()) {
    ...
    tmp27 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{p_index}, TNode<IntPtrT>{tmp26});
    tmp28 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp18}, TNode<IntPtrT>{tmp27});
    std::tie(tmp29, tmp30) = NewReference_Object_0(state_, TNode<HeapObject>{tmp17}, TNode<IntPtrT>{tmp28}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp29, tmp30}, p_element);
...
TNode<Object> CycleProtectedArrayJoin_JSArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_useToLocaleString, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Object> p_sepObj, TNode<Object> p_locales, TNode<Object> p_options) {
  ...
  if (block4.is_used()) {
    ...
    ca_.Branch(tmp5, &block8, std::vector<Node*>{}, &block9, std::vector<Node*>{});
  }
