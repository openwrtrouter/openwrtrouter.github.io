...
USE(parameter1);
  ...
  if (block15.is_used()) {
    ...
    tmp10 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArrayEveryLoopContinuation, parameter0, tmp0, tmp2, parameter3, tmp8, tmp0, tmp4, tmp6, tmp9);
...
USE(parameter1);
  ...
  if (block18.is_used()) {
    ...
    tmp15 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArrayEveryLoopContinuation, parameter0, tmp0, tmp2, parameter3, tmp13, tmp0, tmp12, tmp6, tmp14);
...
TF_BUILTIN(ArrayEveryLoopContinuation, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    ca_.Branch(tmp7, &block7, std::vector<Node*>{phi_bb5_9}, &block8, std::vector<Node*>{phi_bb5_9});
  }
...
TNode<Object> FastArrayEvery_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block27.is_used()) {
    ...
    ca_.Branch(tmp25, &block36, std::vector<Node*>{phi_bb27_5}, &block37, std::vector<Node*>{phi_bb27_5});
  }
...
USE(parameter1);
  ...
  if (block10.is_used()) {
    ...
    tmp16 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArrayEveryLoopContinuation, parameter0, tmp1, tmp7, tmp10, tmp14, tmp1, tmp13.value(), tmp2, tmp15);
