...
TF_BUILTIN(CreateObjectWithoutProperties, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = Cast_Null_1(state_, TNode<Context>{parameter0}, TNode<Object>{parameter1}, &label2);
    ca_.Goto(&block5);
    if (label2.is_used()) {
      ca_.Bind(&label2);
      ca_.Goto(&block6);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    compiler::CodeAssemblerLabel label4(&ca_);
    tmp3 = Cast_JSReceiver_1(state_, TNode<Context>{parameter0}, TNode<Object>{ca_.UncheckedCast<Object>(parameter1)}, &label4);
    ca_.Goto(&block9);
    if (label4.is_used()) {
      ca_.Bind(&label4);
      ca_.Goto(&block10);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp5 = FromConstexpr_NativeContextSlot_constexpr_SLOW_OBJECT_WITH_NULL_PROTOTYPE_MAP_0(state_, Context::Field::SLOW_OBJECT_WITH_NULL_PROTOTYPE_MAP);
    tmp6 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp0}, TNode<IntPtrT>{tmp5});
    tmp7 = UnsafeCast_Map_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp6});
  ...
  if (block9.is_used()) {
    ...
    tmp10 = FromConstexpr_NativeContextSlot_constexpr_OBJECT_FUNCTION_INDEX_0(state_, Context::Field::OBJECT_FUNCTION_INDEX);
    tmp11 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{tmp0}, TNode<IntPtrT>{tmp10});
    tmp12 = UnsafeCast_JSFunction_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp11});
    tmp13 = FromConstexpr_intptr_constexpr_int31_0(state_, 28);
    ...
    tmp18 = CodeStubAssembler(state_).TaggedNotEqual(TNode<HeapObject>{tmp3}, TNode<HeapObject>{tmp17});
    ca_.Branch(tmp18, &block11, std::vector<Node*>{}, &block12, std::vector<Node*>{tmp15});
  }
  ...
  if (block11.is_used()) {
    ...
    tmp20 = CodeStubAssembler(state_).LoadReference<Map>(CodeStubAssembler::Reference{tmp3, tmp19});
  ...
  if (block13.is_used()) {
    ...
    tmp24 = CodeStubAssembler(state_).LoadReference<MaybeObject>(CodeStubAssembler::Reference{tmp21, tmp23});
    compiler::CodeAssemblerLabel label26(&ca_);
    tmp25 = Cast_Undefined_0(state_, TNode<MaybeObject>{tmp24}, &label26);
    ca_.Goto(&block17);
    if (label26.is_used()) {
      ca_.Bind(&label26);
      ca_.Goto(&block18);
  ...
  if (block18.is_used()) {
    ...
    tmp27 = WeakToStrong_Map_0(state_, TNode<MaybeObject>{ca_.UncheckedCast<MaybeObject>(tmp24)}, &label28);
    ca_.Goto(&block19);
    if (label28.is_used()) {
      ca_.Bind(&label28);
      ca_.Goto(&block20);
  ...
  if (block19.is_used()) {
    ca_.Bind(&block19);
    ca_.Goto(&block12, tmp27);
  }

  TNode<Map> phi_bb12_3;
  if (block12.is_used()) {
    ca_.Bind(&block12, &phi_bb12_3);
    ca_.Goto(&block3, phi_bb12_3, tmp9);
  }

  TNode<Map> phi_bb3_3;
  TNode<FixedArray> phi_bb3_4;
  TNode<JSObject> tmp29;
  if (block3.is_used()) {
    ca_.Bind(&block3, &phi_bb3_3, &phi_bb3_4);
    tmp29 = CodeStubAssembler(state_).AllocateJSObjectFromMap(TNode<Map>{phi_bb3_3}, TNode<HeapObject>{phi_bb3_4});
  ...
  if (block2.is_used()) {
    ...
    tmp31 = CodeStubAssembler(state_).CallRuntime(Runtime::kObjectCreate, parameter0, parameter1, tmp30); 
