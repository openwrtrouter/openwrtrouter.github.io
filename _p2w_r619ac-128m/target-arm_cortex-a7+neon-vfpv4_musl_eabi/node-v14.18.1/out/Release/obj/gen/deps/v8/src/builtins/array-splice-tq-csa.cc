...
TNode<Object> FastArraySplice_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSReceiver> p_o, TNode<Number> p_originalLengthNumber, TNode<Number> p_actualStartNumber, TNode<Smi> p_insertCount, TNode<Number> p_actualDeleteCountNumber, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block14.is_used()) {
    ...
    ca_.Branch(tmp15, &block15, std::vector<Node*>{}, &block16, std::vector<Node*>{});
  }
  ...
  if (block17.is_used()) {
    ...
    ca_.Branch(tmp19, &block19, std::vector<Node*>{}, &block20, std::vector<Node*>{});
  }
  ...
  if (block23.is_used()) {
    ...
    ca_.Branch(tmp21, &block21, std::vector<Node*>{phi_bb23_16, phi_bb23_18}, &block22, std::vector<Node*>{phi_bb23_16, phi_bb23_18});
  }
  ...
  if (block21.is_used()) {
    ...
    ca_.Branch(tmp23, &block25, std::vector<Node*>{phi_bb21_16, phi_bb21_18}, &block26, std::vector<Node*>{phi_bb21_16, phi_bb21_18});
  }
  ...
  if (block25.is_used()) {
    ...
    ca_.Branch(tmp24, &block28, std::vector<Node*>{phi_bb25_16, phi_bb25_18}, &block29, std::vector<Node*>{phi_bb25_16, phi_bb25_18});
  }
  ...
  if (block28.is_used()) {
    ...
    tmp26 = CodeStubAssembler(state_).IsHeapNumber(TNode<HeapObject>{tmp25});
    ca_.Branch(tmp26, &block30, std::vector<Node*>{phi_bb28_16, phi_bb28_18}, &block31, std::vector<Node*>{phi_bb28_16, phi_bb28_18});
  }
  ...
  if (block26.is_used()) {
    ...
    ca_.Branch(tmp29, &block34, std::vector<Node*>{phi_bb26_16, phi_bb26_18}, &block35, std::vector<Node*>{phi_bb26_16, phi_bb26_18});
  }
  ...
  if (block34.is_used()) {
    ...
    tmp30 = CodeStubAssembler(state_).IsNumber(TNode<Object>{tmp22});
    tmp31 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{tmp30});
    ca_.Branch(tmp31, &block36, std::vector<Node*>{phi_bb34_16, phi_bb34_18}, &block37, std::vector<Node*>{phi_bb34_16, phi_bb34_18});
  }
  ...
  if (block22.is_used()) {
    ...
    ca_.Branch(tmp35, &block38, std::vector<Node*>{phi_bb22_16}, &block39, std::vector<Node*>{phi_bb22_16});
  }
  ...
  if (block40.is_used()) {
    ...
    ca_.Branch(tmp42, &block42, std::vector<Node*>{phi_bb40_16}, &block43, std::vector<Node*>{phi_bb40_16});
  }
  ...
  if (block43.is_used()) {
    ...
    tmp43 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kExtractFastJSArray, p_context, tmp8, tmp2, tmp4));
    tmp44 = FromConstexpr_Smi_constexpr_int31_0(state_, 0);
    tmp45 = CodeStubAssembler(state_).SmiEqual(TNode<Smi>{tmp7}, TNode<Smi>{tmp44});
    ca_.Branch(tmp45, &block44, std::vector<Node*>{phi_bb43_16}, &block45, std::vector<Node*>{phi_bb43_16});
  }
  ...
  if (block45.is_used()) {
    ...
    ca_.Branch(tmp50, &block46, std::vector<Node*>{phi_bb45_16}, &block47, std::vector<Node*>{phi_bb45_16});
  }
...
TNode<Object> FillDeletedElementsArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_actualStart, TNode<Number> p_actualDeleteCount, TNode<JSReceiver> p_a) {
  ...
  if (block4.is_used()) {
    ...
    ca_.Branch(tmp1, &block2, std::vector<Node*>{phi_bb4_5}, &block3, std::vector<Node*>{phi_bb4_5});
  }
  ...
  if (block2.is_used()) {
    ...
    tmp3 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kHasProperty, p_context, p_o, tmp2));
    tmp4 = True_0(state_);
    tmp5 = CodeStubAssembler(state_).TaggedEqual(TNode<HeapObject>{tmp3}, TNode<HeapObject>{tmp4});
    ca_.Branch(tmp5, &block5, std::vector<Node*>{phi_bb2_5}, &block6, std::vector<Node*>{phi_bb2_5});
  }
  ...
  if (block5.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).CallBuiltin(Builtins::kFastCreateDataProperty, p_context, p_a, phi_bb5_5, tmp6);
  ...
  if (block3.is_used()) {
    ...
    tmp11 = CodeStubAssembler(state_).CallBuiltin(Builtins::kSetProperty, p_context, p_a, tmp10, p_actualDeleteCount);
    ca_.Goto(&block7);
  }
...
void HandleForwardCase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Number> p_itemCount, TNode<Number> p_actualStart, TNode<Number> p_actualDeleteCount) {
  ...
  if (block4.is_used()) {
    ...
    ca_.Branch(tmp1, &block2, std::vector<Node*>{phi_bb4_6}, &block3, std::vector<Node*>{phi_bb4_6});
  }
  ...
  if (block2.is_used()) {
    ...
    tmp4 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kHasProperty, p_context, p_o, tmp2));
    tmp5 = True_0(state_);
    tmp6 = CodeStubAssembler(state_).TaggedEqual(TNode<HeapObject>{tmp4}, TNode<HeapObject>{tmp5});
    ca_.Branch(tmp6, &block5, std::vector<Node*>{phi_bb2_6}, &block6, std::vector<Node*>{phi_bb2_6});
  }
  ...
  if (block5.is_used()) {
    ...
    tmp8 = CodeStubAssembler(state_).CallBuiltin(Builtins::kSetProperty, p_context, p_o, tmp3, tmp7);
  ...
  if (block6.is_used()) {
    ...
    tmp10 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kDeleteProperty, p_context, p_o, tmp3, tmp9));
  ...
  if (block10.is_used()) {
    ...
    ca_.Branch(tmp15, &block8, std::vector<Node*>{phi_bb10_6}, &block9, std::vector<Node*>{phi_bb10_6});
  }
  ...
  if (block8.is_used()) {
    ...
    tmp19 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kDeleteProperty, p_context, p_o, tmp17, tmp18));
...
void HandleBackwardCase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Number> p_itemCount, TNode<Number> p_actualStart, TNode<Number> p_actualDeleteCount) {
  ...
  if (block2.is_used()) {
    ...
    tmp8 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kHasProperty, p_context, p_o, tmp4));
    tmp9 = True_0(state_);
    tmp10 = CodeStubAssembler(state_).TaggedEqual(TNode<HeapObject>{tmp8}, TNode<HeapObject>{tmp9});
    ca_.Branch(tmp10, &block5, std::vector<Node*>{phi_bb2_6}, &block6, std::vector<Node*>{phi_bb2_6});
  }
  ...
  if (block5.is_used()) {
    ...
    tmp12 = CodeStubAssembler(state_).CallBuiltin(Builtins::kSetProperty, p_context, p_o, tmp7, tmp11);
    ca_.Goto(&block7, phi_bb5_6);
  }
  ...
  if (block6.is_used()) {
    ...
    tmp14 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kDeleteProperty, p_context, p_o, tmp7, tmp13));
    ca_.Goto(&block7, phi_bb6_6);
  }
...
TNode<Object> SlowSplice_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_arguments, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Number> p_actualStart, TNode<Smi> p_insertCount, TNode<Number> p_actualDeleteCount) {
  ...
  if (block4.is_used()) {
    ...
    ca_.Branch(tmp5, &block7, std::vector<Node*>{}, &block8, std::vector<Node*>{p_actualStart});
  }
  ...
  if (block11.is_used()) {
    ...
    ca_.Branch(tmp7, &block9, std::vector<Node*>{phi_bb11_11, phi_bb11_12}, &block10, std::vector<Node*>{phi_bb11_11, phi_bb11_12});
  }
  ...
  if (block9.is_used()) {
    ...
    tmp9 = CodeStubAssembler(state_).CallBuiltin(Builtins::kSetProperty, p_context, p_o, phi_bb9_11, tmp8);
  ...
  if (block8.is_used()) {
    ...
    tmp17 = CodeStubAssembler(state_).CallBuiltin(Builtins::kSetProperty, p_context, p_o, tmp14, tmp16);
    ca_.Goto(&block13);
  }
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kToObject, parameter0, parameter1));
  ...
  if (block7.is_used()) {
    ...
    ca_.Branch(tmp32, &block11, std::vector<Node*>{phi_bb7_10, phi_bb7_11}, &block12, std::vector<Node*>{phi_bb7_10, phi_bb7_11});
  }
...
void FastSplice_FixedArray_JSAny_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSArray> p_a, TNode<Smi> p_length, TNode<Smi> p_newLength, TNode<Smi> p_actualStart, TNode<Smi> p_insertCount, TNode<Smi> p_actualDeleteCount) {
  ...
  if (block10.is_used()) {
    ...
    ca_.Branch(tmp24, &block12, std::vector<Node*>{}, &block13, std::vector<Node*>{});
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp27, &block14, std::vector<Node*>{}, &block15, std::vector<Node*>{p_actualStart});
  }
  ...
  if (block18.is_used()) {
    ...
    ca_.Branch(tmp32, &block16, std::vector<Node*>{phi_bb18_10, phi_bb18_12}, &block17, std::vector<Node*>{phi_bb18_10, phi_bb18_12});
  }
...
void FastSplice_FixedDoubleArray_Number_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSArray> p_a, TNode<Smi> p_length, TNode<Smi> p_newLength, TNode<Smi> p_actualStart, TNode<Smi> p_insertCount, TNode<Smi> p_actualDeleteCount) {
  ...
  if (block2.is_used()) {
    ...
    tmp1 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp2 = CodeStubAssembler(state_).LoadReference<FixedArrayBase>(CodeStubAssembler::Reference{p_a, tmp1});
    tmp3 = UnsafeCast_EmptyFixedArray_OR_FixedDoubleArray_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp2});
    tmp4 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{p_actualStart}, TNode<Smi>{p_insertCount});
    tmp5 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{p_actualStart}, TNode<Smi>{p_actualDeleteCount});
    tmp6 = CodeStubAssembler(state_).SmiSub(TNode<Smi>{p_length}, TNode<Smi>{p_actualDeleteCount});
    tmp7 = CodeStubAssembler(state_).SmiSub(TNode<Smi>{tmp6}, TNode<Smi>{p_actualStart});
...
void StoreHoles_FixedArray_0(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_elements, TNode<Smi> p_holeStartIndex, TNode<Smi> p_holeEndIndex) {
  ...
  if (block4.is_used()) {
    ...
    ca_.Branch(tmp0, &block2, std::vector<Node*>{phi_bb4_3}, &block3, std::vector<Node*>{phi_bb4_3});
  }
...
TNode<FixedArrayBase> UnsafeCast_EmptyFixedArray_OR_FixedDoubleArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
