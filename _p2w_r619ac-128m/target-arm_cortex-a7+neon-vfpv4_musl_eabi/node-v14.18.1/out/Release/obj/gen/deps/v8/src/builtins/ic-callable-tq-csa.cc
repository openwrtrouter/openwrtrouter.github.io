...
void TryInitializeAsMonomorphic_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_maybeTarget, TNode<FeedbackVector> p_feedbackVector, TNode<UintPtrT> p_slotId, compiler::CodeAssemblerLabel* label_TransitionToMegamorphic) {
  ...
  if (block6.is_used()) {
    ...
    tmp6 = Cast_JSFunction_0(state_, TNode<Context>{p_context}, TNode<HeapObject>{phi_bb6_5}, &label7);
...
void CollectCallFeedback_0(compiler::CodeAssemblerState* state_, TNode<Object> p_maybeTarget, TNode<Context> p_context, TNode<HeapObject> p_maybeFeedbackVector, TNode<UintPtrT> p_slotId) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    compiler::CodeAssemblerLabel label1(&ca_);
    tmp0 = Cast_FeedbackVector_0(state_, TNode<Context>{p_context}, TNode<HeapObject>{p_maybeFeedbackVector}, &label1);
    ca_.Goto(&block4);
    if (label1.is_used()) {
      ca_.Bind(&label1);
      ca_.Goto(&block5);
  ...
  if (block21.is_used()) {
    ...
    tmp13 = Cast_JSFunction_0(state_, TNode<Context>{p_context}, TNode<HeapObject>{tmp6}, &label14);
    ca_.Goto(&block22);
    if (label14.is_used()) {
      ca_.Bind(&label14);
      ca_.Goto(&block23);
...
TNode<JSFunction> Cast_JSFunction_1(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block3.is_used()) {
    ...
    tmp2 = Cast_JSFunction_0(state_, TNode<Context>{p_context}, TNode<HeapObject>{tmp0}, &label3);
    ca_.Goto(&block5);
    if (label3.is_used()) {
      ca_.Bind(&label3);
      ca_.Goto(&block6);
