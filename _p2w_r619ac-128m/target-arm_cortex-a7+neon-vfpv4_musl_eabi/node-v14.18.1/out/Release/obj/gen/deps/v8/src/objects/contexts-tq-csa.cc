...
TNode<ScopeInfo> LoadContextScopeInfo_0(compiler::CodeAssemblerState* state_, TNode<Context> p_o) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).LoadReference<ScopeInfo>(CodeStubAssembler::Reference{p_o, tmp0});
    ca_.Goto(&block2);
  }
...
void StoreContextScopeInfo_0(compiler::CodeAssemblerState* state_, TNode<Context> p_o, TNode<ScopeInfo> p_v) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    CodeStubAssembler(state_).StoreReference<ScopeInfo>(CodeStubAssembler::Reference{p_o, tmp0}, p_v);
    ca_.Goto(&block2);
  }
