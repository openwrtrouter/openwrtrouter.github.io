...
USE(parameter1);
  ...
  if (block11.is_used()) {
    ...
    tmp8 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArrayReduceLoopContinuation, parameter0, tmp0, tmp2, tmp6, tmp0, tmp7, tmp4);
...
USE(parameter1);
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    tmp8 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArrayReduceLoopContinuation, parameter0, tmp0, tmp2, parameter5, tmp0, tmp4, tmp6);
    CodeStubAssembler(state_).Return(tmp8);
  }
}
...
TF_BUILTIN(ArrayReduceLoopContinuation, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp0, &block1, std::vector<Node*>{phi_bb3_7, phi_bb3_8}, &block2, std::vector<Node*>{phi_bb3_7, phi_bb3_8});
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.Branch(tmp3, &block5, std::vector<Node*>{phi_bb1_7, phi_bb1_8}, &block6, std::vector<Node*>{phi_bb1_7, phi_bb1_8});
  }
...
TNode<Object> FastArrayReduce_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_initialAccumulator, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Object>* label_Bailout_parameter_1) {
  ...
  if (block13.is_used()) {
    ...
    ca_.Branch(tmp11, &block11, std::vector<Node*>{phi_bb13_5, phi_bb13_8, phi_bb13_11}, &block12, std::vector<Node*>{phi_bb13_5, phi_bb13_8, phi_bb13_11});
  }
  ...
  if (block11.is_used()) {
    ...
    ca_.Branch(tmp14, &block18, std::vector<Node*>{phi_bb11_5, phi_bb11_8, phi_bb11_11}, &block19, std::vector<Node*>{phi_bb11_5, phi_bb11_8, phi_bb11_11});
  }
  ...
  if (block19.is_used()) {
    ...
    ca_.Branch(tmp15, &block20, std::vector<Node*>{phi_bb19_5, phi_bb19_8, phi_bb19_11}, &block21, std::vector<Node*>{phi_bb19_5, phi_bb19_8, phi_bb19_11});
  }
  ...
  if (block21.is_used()) {
    ...
    ca_.Branch(tmp19, &block22, std::vector<Node*>{phi_bb21_5, phi_bb21_11}, &block23, std::vector<Node*>{phi_bb21_5, phi_bb21_11});
  }
  ...
  if (block23.is_used()) {
    ...
    ca_.Branch(tmp9, &block28, std::vector<Node*>{phi_bb23_5, phi_bb23_11, phi_bb23_11, phi_bb23_11}, &block29, std::vector<Node*>{phi_bb23_5, phi_bb23_11, phi_bb23_11, phi_bb23_11});
  }
...
USE(parameter1);
  ...
  if (block14.is_used()) {
    ca_.Bind(&block14);
    tmp18 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArrayReduceLoopContinuation, parameter0, tmp1, tmp7, tmp17.value(), tmp1, tmp16.value(), tmp2);
