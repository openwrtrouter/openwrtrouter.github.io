...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_NativeContextSlot_constexpr_MATH_RANDOM_INDEX_INDEX_0(state_, Context::Field::MATH_RANDOM_INDEX_INDEX);
    tmp1 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{parameter0}, TNode<IntPtrT>{tmp0});
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp5, &block5, std::vector<Node*>{}, &block6, std::vector<Node*>{tmp2});
  }
  ...
  if (block6.is_used()) {
    ...
    tmp8 = CodeStubAssembler(state_).SmiSub(TNode<Smi>{phi_bb6_2}, TNode<Smi>{tmp7});
    tmp9 = FromConstexpr_NativeContextSlot_constexpr_MATH_RANDOM_INDEX_INDEX_0(state_, Context::Field::MATH_RANDOM_INDEX_INDEX);
    CodeStubAssembler(state_).StoreContextElement(TNode<NativeContext>{parameter0}, TNode<IntPtrT>{tmp9}, TNode<Object>{tmp8});
    tmp10 = FromConstexpr_NativeContextSlot_constexpr_MATH_RANDOM_CACHE_INDEX_0(state_, Context::Field::MATH_RANDOM_CACHE_INDEX);
    tmp11 = CodeStubAssembler(state_).LoadContextElement(TNode<NativeContext>{parameter0}, TNode<IntPtrT>{tmp10});
    compiler::CodeAssemblerLabel label13(&ca_);
    tmp12 = Cast_FixedDoubleArray_1(state_, TNode<Context>{parameter0}, TNode<Object>{tmp11}, &label13);
    ca_.Goto(&block9);
    if (label13.is_used()) {
      ca_.Bind(&label13);
      ca_.Goto(&block10);
  ...
  if (block9.is_used()) {
    ...
    tmp15 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    tmp16 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    tmp17 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp12, tmp16});
    tmp18 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp17});
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    tmp23 = FromConstexpr_intptr_constexpr_int31_0(state_, kDoubleSize);
    tmp24 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp19}, TNode<IntPtrT>{tmp23});
    tmp25 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp14}, TNode<IntPtrT>{tmp24});
    std::tie(tmp26, tmp27) = NewReference_float64_or_hole_0(state_, TNode<HeapObject>{tmp12}, TNode<IntPtrT>{tmp25}).Flatten();
    std::tie(tmp28, tmp29) = LoadFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0{TNode<HeapObject>{tmp26}, TNode<IntPtrT>{tmp27}, TorqueStructUnsafe_0{}}).Flatten();
