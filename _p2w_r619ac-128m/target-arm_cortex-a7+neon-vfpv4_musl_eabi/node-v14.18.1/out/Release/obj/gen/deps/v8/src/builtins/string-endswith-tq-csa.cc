...
TNode<Oddball> TryFastStringCompareSequence_0(compiler::CodeAssemblerState* state_, TNode<String> p_string, TNode<String> p_searchStr, TNode<UintPtrT> p_start, TNode<UintPtrT> p_searchLength, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT> block9(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT> block7(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT> block10(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT> block11(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT> block8(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    tmp0 = Cast_DirectString_0(state_, TNode<HeapObject>{p_string}, &label1);
    ca_.Goto(&block3);
    if (label1.is_used()) {
      ca_.Bind(&label1);
      ca_.Goto(&block4);
  ...
  if (block3.is_used()) {
    ...
    tmp2 = Cast_DirectString_0(state_, TNode<HeapObject>{p_searchStr}, &label3);
    ca_.Goto(&block5);
    if (label3.is_used()) {
      ca_.Bind(&label3);
      ca_.Goto(&block6);
  ...
  if (block5.is_used()) {
    ...
    ca_.Goto(&block9, tmp4, p_start);
  }

  TNode<UintPtrT> phi_bb9_6;
  TNode<UintPtrT> phi_bb9_7;
  TNode<BoolT> tmp5;
  if (block9.is_used()) {
    ca_.Bind(&block9, &phi_bb9_6, &phi_bb9_7);
    tmp5 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{phi_bb9_6}, TNode<UintPtrT>{p_searchLength});
    ca_.Branch(tmp5, &block7, std::vector<Node*>{phi_bb9_6, phi_bb9_7}, &block8, std::vector<Node*>{phi_bb9_6, phi_bb9_7});
  }

  TNode<UintPtrT> phi_bb7_6;
  TNode<UintPtrT> phi_bb7_7;
  TNode<Int32T> tmp6;
  TNode<Int32T> tmp7;
  TNode<BoolT> tmp8;
  if (block7.is_used()) {
    ca_.Bind(&block7, &phi_bb7_6, &phi_bb7_7);
    tmp6 = CodeStubAssembler(state_).StringCharCodeAt(TNode<String>{tmp2}, TNode<UintPtrT>{phi_bb7_6});
    tmp7 = CodeStubAssembler(state_).StringCharCodeAt(TNode<String>{tmp0}, TNode<UintPtrT>{phi_bb7_7});
    tmp8 = CodeStubAssembler(state_).Word32NotEqual(TNode<Int32T>{tmp6}, TNode<Int32T>{tmp7});
    ca_.Branch(tmp8, &block10, std::vector<Node*>{phi_bb7_6, phi_bb7_7}, &block11, std::vector<Node*>{phi_bb7_6, phi_bb7_7});
  }

  TNode<UintPtrT> phi_bb10_6;
  TNode<UintPtrT> phi_bb10_7;
  TNode<Oddball> tmp9;
  if (block10.is_used()) {
  ...
  if (block11.is_used()) {
    ...
    tmp11 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{phi_bb11_6}, TNode<UintPtrT>{tmp10});
    tmp12 = FromConstexpr_uintptr_constexpr_int31_0(state_, 1);
    tmp13 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{phi_bb11_7}, TNode<UintPtrT>{tmp12});
    ca_.Goto(&block9, tmp11, tmp13);
  }

  TNode<UintPtrT> phi_bb8_6;
  ...
  if (block1.is_used()) {
    ...
    ca_.Bind(&block12);
  return TNode<Oddball>{phi_bb2_4};
}
...
USE(parameter1);
  ...
  if (block2.is_used()) {
    ...
    ca_.Branch(tmp10, &block3, std::vector<Node*>{}, &block4, std::vector<Node*>{});
  }
  ...
  if (block5.is_used()) {
    ...
    ca_.Branch(tmp16, &block7, std::vector<Node*>{}, &block8, std::vector<Node*>{});
  }
  ...
  if (block8.is_used()) {
    ...
    tmp18 = TryFastStringCompareSequence_0(state_, TNode<String>{tmp5}, TNode<String>{tmp7}, TNode<UintPtrT>{tmp13}, TNode<UintPtrT>{tmp12}, &label19);
    ca_.Goto(&block11);
    if (label19.is_used()) {
      ca_.Bind(&label19);
      ca_.Goto(&block12);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    tmp20 = Convert_Number_uintptr_0(state_, TNode<UintPtrT>{tmp13});
    tmp21 = TORQUE_CAST(CodeStubAssembler(state_).CallRuntime(Runtime::kStringCompareSequence, parameter0, tmp5, tmp7, tmp20)); 
