...
TNode<Object> ReduceAllElements_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_callbackfn, TNode<Object> p_initialValue) {
  ...
  if (block5.is_used()) {
    ...
    ca_.Branch(tmp6, &block3, std::vector<Node*>{phi_bb5_5, phi_bb5_8, phi_bb5_9}, &block4, std::vector<Node*>{phi_bb5_5, phi_bb5_8, phi_bb5_9});
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp9, &block10, std::vector<Node*>{phi_bb3_5, phi_bb3_8, phi_bb3_9}, &block11, std::vector<Node*>{phi_bb3_5, phi_bb3_8, phi_bb3_9});
  }
