...
TNode<Number> LoadDataView16_0(compiler::CodeAssemblerState* state_, TNode<JSArrayBuffer> p_buffer, TNode<UintPtrT> p_offset, TNode<BoolT> p_requestedLittleEndian, bool p_signed) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).LoadJSArrayBufferBackingStorePtr(TNode<JSArrayBuffer>{p_buffer});
    ca_.Branch(p_requestedLittleEndian, &block2, std::vector<Node*>{}, &block3, std::vector<Node*>{});
  }
...
TNode<BigInt> MakeBigIntOn64Bit_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Uint32T> p_lowWord, TNode<Uint32T> p_highWord, bool p_signed) {
  ...
  if (block6.is_used()) {
    ...
    ca_.Branch(phi_bb6_4, &block2, std::vector<Node*>{}, &block3, std::vector<Node*>{});
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Branch(tmp17, &block10, std::vector<Node*>{}, &block11, std::vector<Node*>{tmp8, tmp15});
  }
...
TNode<BigInt> MakeBigIntOn32Bit_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Uint32T> p_lowWord, TNode<Uint32T> p_highWord, bool p_signed) {
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp13, &block7, std::vector<Node*>{}, &block8, std::vector<Node*>{tmp8, tmp9, tmp10, tmp11});
  }
  ...
  if (block12.is_used()) {
    ...
    ca_.Branch(tmp20, &block15, std::vector<Node*>{}, &block16, std::vector<Node*>{tmp18});
  }
  ...
  if (block16.is_used()) {
    ...
    ca_.Branch(tmp26, &block17, std::vector<Node*>{}, &block18, std::vector<Node*>{tmp8});
  }
  ...
  if (block8.is_used()) {
    ...
    ca_.Branch(phi_bb8_3, &block19, std::vector<Node*>{phi_bb8_3, phi_bb8_4, phi_bb8_5, phi_bb8_6}, &block20, std::vector<Node*>{phi_bb8_3, phi_bb8_4, phi_bb8_5, phi_bb8_6});
  }
  ...
  if (block21.is_used()) {
    ...
    ca_.Branch(phi_bb21_3, &block22, std::vector<Node*>{phi_bb21_3, phi_bb21_4, phi_bb21_5, phi_bb21_6}, &block23, std::vector<Node*>{phi_bb21_3, phi_bb21_4, phi_bb21_5, phi_bb21_6});
  }
...
void StoreDataViewBigInt_0(compiler::CodeAssemblerState* state_, TNode<JSArrayBuffer> p_buffer, TNode<UintPtrT> p_offset, TNode<BigInt> p_bigIntValue, TNode<BoolT> p_requestedLittleEndian) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Branch(tmp5, &block2, std::vector<Node*>{}, &block3, std::vector<Node*>{tmp2, tmp3});
  }
  ...
  if (block5.is_used()) {
    ...
    ca_.Branch(tmp16, &block7, std::vector<Node*>{}, &block8, std::vector<Node*>{tmp3});
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp21, &block9, std::vector<Node*>{phi_bb3_6, phi_bb3_7}, &block10, std::vector<Node*>{phi_bb3_6, phi_bb3_7});
  }
  ...
  if (block9.is_used()) {
    ...
    ca_.Branch(tmp27, &block11, std::vector<Node*>{phi_bb9_6}, &block12, std::vector<Node*>{phi_bb9_6, tmp25});
  }
