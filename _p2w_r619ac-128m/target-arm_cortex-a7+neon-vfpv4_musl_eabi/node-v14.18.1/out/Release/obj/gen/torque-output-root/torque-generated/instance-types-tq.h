...
#define TORQUE_ASSIGNED_INSTANCE_TYPES(V) \
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(FIRST_STRUCT_TYPE, 71) \
      ...
      V(PROMISE_CAPABILITY_TYPE, 100) \
      V(PROMISE_REACTION_TYPE, 101) \
      V(PROPERTY_DESCRIPTOR_OBJECT_TYPE, 102) \
      V(PROTOTYPE_INFO_TYPE, 103) \
      V(SCRIPT_TYPE, 104) \
      V(SOURCE_TEXT_MODULE_INFO_ENTRY_TYPE, 105) \
      V(STACK_FRAME_INFO_TYPE, 106) \
      V(STACK_TRACE_FRAME_TYPE, 107) \
      V(TEMPLATE_OBJECT_DESCRIPTION_TYPE, 108) \
      V(TUPLE2_TYPE, 109) \
      V(WASM_CAPI_FUNCTION_DATA_TYPE, 110) \
      V(WASM_DEBUG_INFO_TYPE, 111) \
    ...
    V(FIRST_FIXED_ARRAY_BASE_TYPE, 117) \
      V(FIRST_FIXED_ARRAY_TYPE, 117) \
        ...
        V(FIRST_HASH_TABLE_TYPE, 118) \
          ...
          V(STRING_TABLE_TYPE, 127) \
        V(LAST_HASH_TABLE_TYPE, 127) \
        V(CLOSURE_FEEDBACK_CELL_ARRAY_TYPE, 128) \
        V(OBJECT_BOILERPLATE_DESCRIPTION_TYPE, 129) \
        V(SCOPE_INFO_TYPE, 130) \
        V(SCRIPT_CONTEXT_TABLE_TYPE, 131) \
      V(LAST_FIXED_ARRAY_TYPE, 131) \
      V(BYTE_ARRAY_TYPE, 132) \
      V(BYTECODE_ARRAY_TYPE, 133) \
      V(FIXED_DOUBLE_ARRAY_TYPE, 134) \
      V(INTERNAL_CLASS_WITH_SMI_ELEMENTS_TYPE, 135) \
    ...
    V(FIRST_EXPORTED_SUB_CLASS_BASE_TYPE, 149) \
      V(EXPORTED_SUB_CLASS_BASE_TYPE, 149) \
      V(EXPORTED_SUB_CLASS_TYPE, 150) \
    V(LAST_EXPORTED_SUB_CLASS_BASE_TYPE, 150) \
    V(FIRST_MODULE_TYPE, 151) \
      V(SOURCE_TEXT_MODULE_TYPE, 151) \
      V(SYNTHETIC_MODULE_TYPE, 152) \
    V(LAST_MODULE_TYPE, 152) \
    V(FIRST_UNCOMPILED_DATA_TYPE, 153) \
      V(UNCOMPILED_DATA_WITH_PREPARSE_DATA_TYPE, 153) \
      V(UNCOMPILED_DATA_WITHOUT_PREPARSE_DATA_TYPE, 154) \
    V(LAST_UNCOMPILED_DATA_TYPE, 154) \
    V(FIRST_WEAK_FIXED_ARRAY_TYPE, 155) \
      V(WEAK_FIXED_ARRAY_TYPE, 155) \
      V(TRANSITION_ARRAY_TYPE, 156) \
    V(LAST_WEAK_FIXED_ARRAY_TYPE, 156) \
    V(CELL_TYPE, 157) \
    V(CODE_TYPE, 158) \
    V(CODE_DATA_CONTAINER_TYPE, 159) \
    V(COVERAGE_INFO_TYPE, 160) \
    V(DESCRIPTOR_ARRAY_TYPE, 161) \
    V(EMBEDDER_DATA_ARRAY_TYPE, 162) \
    V(FEEDBACK_METADATA_TYPE, 163) \
    V(FEEDBACK_VECTOR_TYPE, 164) \
    V(FILLER_TYPE, 165) \
    V(FREE_SPACE_TYPE, 166) \
    V(INTERNAL_CLASS_TYPE, 167) \
    V(INTERNAL_CLASS_WITH_STRUCT_ELEMENTS_TYPE, 168) \
    V(MAP_TYPE, 169) \
    V(PREPARSE_DATA_TYPE, 170) \
    V(PROPERTY_ARRAY_TYPE, 171) \
    V(PROPERTY_CELL_TYPE, 172) \
    V(SHARED_FUNCTION_INFO_TYPE, 173) \
    V(SMI_BOX_TYPE, 174) \
    V(SMI_PAIR_TYPE, 175) \
    V(SORT_STATE_TYPE, 176) \
    V(WASM_ARRAY_TYPE, 177) \
    V(WASM_STRUCT_TYPE, 178) \
    V(WEAK_ARRAY_LIST_TYPE, 179) \
    V(WEAK_CELL_TYPE, 180) \
    V(FIRST_JS_RECEIVER_TYPE, 181) \
      V(JS_PROXY_TYPE, 181) \
      V(FIRST_JS_OBJECT_TYPE, 182) \
        V(JS_OBJECT_TYPE, 1057) \
        V(FIRST_JS_CUSTOM_ELEMENTS_OBJECT_TYPE, 182) \
          V(FIRST_JS_SPECIAL_OBJECT_TYPE, 182) \
            V(JS_GLOBAL_OBJECT_TYPE, 182) \
            V(JS_GLOBAL_PROXY_TYPE, 183) \
            V(JS_MODULE_NAMESPACE_TYPE, 184) \
        ...
        V(JS_AGGREGATE_ERROR_TYPE, 1058) \
        V(JS_ARGUMENTS_OBJECT_TYPE, 1059) \
        V(JS_ARRAY_TYPE, 1060) \
        V(JS_ARRAY_BUFFER_TYPE, 1061) \
        V(JS_ARRAY_ITERATOR_TYPE, 1062) \
        V(JS_ASYNC_FROM_SYNC_ITERATOR_TYPE, 1063) \
        V(JS_CONTEXT_EXTENSION_OBJECT_TYPE, 1064) \
        V(JS_DATE_TYPE, 1065) \
        V(JS_ERROR_TYPE, 1066) \
        V(JS_FINALIZATION_REGISTRY_TYPE, 1067) \
        V(JS_MESSAGE_OBJECT_TYPE, 1068) \
        V(JS_PROMISE_TYPE, 1069) \
        V(JS_REG_EXP_TYPE, 1070) \
        V(JS_REG_EXP_STRING_ITERATOR_TYPE, 1071) \
        V(JS_STRING_ITERATOR_TYPE, 1072) \
        V(JS_WEAK_REF_TYPE, 1073) \
        V(WASM_EXCEPTION_OBJECT_TYPE, 1074) \
        V(WASM_GLOBAL_OBJECT_TYPE, 1075) \
        V(WASM_INSTANCE_OBJECT_TYPE, 1076) \
        V(WASM_MEMORY_OBJECT_TYPE, 1077) \
        V(WASM_MODULE_OBJECT_TYPE, 1078) \
        V(WASM_TABLE_OBJECT_TYPE, 1079) \
        V(FIRST_JS_FUNCTION_OR_BOUND_FUNCTION_TYPE, 1080) \
          V(JS_BOUND_FUNCTION_TYPE, 1080) \
          V(JS_FUNCTION_TYPE, 1081) \
        V(LAST_JS_FUNCTION_OR_BOUND_FUNCTION_TYPE, 1081) \
      V(LAST_JS_OBJECT_TYPE, 1081) \
    V(LAST_JS_RECEIVER_TYPE, 1081) \
  V(LAST_HEAP_OBJECT_TYPE, 1081) \
...
#define TORQUE_INSTANCE_CHECKERS_SINGLE_FULLY_DEFINED(V) \
  ...
  V(JSAggregateError, JS_AGGREGATE_ERROR_TYPE) \
...
// Non-extern Torque classes.
#define TORQUE_INTERNAL_CLASS_LIST(V) \
  V(InternalClass) \
  V(SmiPair) \
  V(SmiBox) \
...
#define TORQUE_INTERNAL_VARSIZE_INSTANCE_TYPE_LIST(V) \
...
#define TORQUE_INTERNAL_FIXED_INSTANCE_TYPE_LIST(V) \
...
#define TORQUE_INTERNAL_INSTANCE_TYPE_LIST(V) \
  TORQUE_INTERNAL_VARSIZE_INSTANCE_TYPE_LIST(V) \
  TORQUE_INTERNAL_FIXED_INSTANCE_TYPE_LIST(V) \

#define TORQUE_INTERNAL_MAP_CSA_LIST(V) \
  V(InternalClassMap, internal_class_map, InternalClassMap) \
  V(SmiPairMap, smi_pair_map, SmiPairMap) \
  V(SmiBoxMap, smi_box_map, SmiBoxMap) \
  V(ExportedSubClassBaseMap, exported_sub_class_base_map, ExportedSubClassBaseMap) \
  V(ExportedSubClassMap, exported_sub_class_map, ExportedSubClassMap) \
  V(AbstractInternalClassSubclass1Map, abstract_internal_class_subclass1_map, AbstractInternalClassSubclass1Map) \
  V(AbstractInternalClassSubclass2Map, abstract_internal_class_subclass2_map, AbstractInternalClassSubclass2Map) \
  V(InternalClassWithSmiElementsMap, internal_class_with_smi_elements_map, InternalClassWithSmiElementsMap) \
  V(InternalClassWithStructElementsMap, internal_class_with_struct_elements_map, InternalClassWithStructElementsMap) \
  V(SortStateMap, sort_state_map, SortStateMap) \

#define TORQUE_INTERNAL_MAP_ROOT_LIST(V) \
