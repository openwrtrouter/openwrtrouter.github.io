...
template <class D, class P>
HeapObject TorqueGeneratedJSAggregateError<D, P>::errors() const {
  const Isolate* isolate = GetIsolateForPtrCompr(*this);
  return TorqueGeneratedJSAggregateError::errors(isolate);
}
template <class D, class P>
HeapObject TorqueGeneratedJSAggregateError<D, P>::errors(const Isolate* isolate) const {
  auto value = TaggedField<HeapObject, kErrorsOffset>::load(isolate, *this);
  DCHECK(value.IsOddball() || value.IsFixedArray());
  return value;
}
template <class D, class P>
void TorqueGeneratedJSAggregateError<D, P>::set_errors(HeapObject value, WriteBarrierMode mode) {
  SLOW_DCHECK(value.IsOddball() || value.IsFixedArray());
  RELAXED_WRITE_FIELD(*this, kErrorsOffset, value);
  CONDITIONAL_WRITE_BARRIER(*this, kErrorsOffset, value, mode);
}

template<class D, class P>
inline TorqueGeneratedJSAggregateError<D, P>::TorqueGeneratedJSAggregateError(Address ptr)
  : P(ptr) {
  SLOW_DCHECK(this->IsJSAggregateError());
}
template<class D, class P>
inline TorqueGeneratedJSAggregateError<D, P>::TorqueGeneratedJSAggregateError(Address ptr, HeapObject::AllowInlineSmiStorage allow_smi)
  : P(ptr, allow_smi) {
  SLOW_DCHECK((allow_smi == HeapObject::AllowInlineSmiStorage::kAllowBeingASmi && this->IsSmi()) || this->IsJSAggregateError());
}
template <class D, class P>
...
HeapObject TorqueGeneratedSourceTextModule<D, P>::cycle_root() const {
  const Isolate* isolate = GetIsolateForPtrCompr(*this);
  return TorqueGeneratedSourceTextModule::cycle_root(isolate);
}
template <class D, class P>
HeapObject TorqueGeneratedSourceTextModule<D, P>::cycle_root(const Isolate* isolate) const {
  auto value = TaggedField<HeapObject, kCycleRootOffset>::load(isolate, *this);
  DCHECK(value.IsOddball() || value.IsSourceTextModule());
  return value;
}
template <class D, class P>
void TorqueGeneratedSourceTextModule<D, P>::set_cycle_root(HeapObject value, WriteBarrierMode mode) {
  SLOW_DCHECK(value.IsOddball() || value.IsSourceTextModule());
  RELAXED_WRITE_FIELD(*this, kCycleRootOffset, value);
...
template <class D, class P>
Object TorqueGeneratedTemplateInfo<D, P>::tag(const Isolate* isolate) const {
  auto value = TaggedField<Object, kTagOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
void TorqueGeneratedTemplateInfo<D, P>::set_tag(Object value, WriteBarrierMode mode) {
  SLOW_DCHECK(value.IsHeapObject() || value.IsSmi());
  RELAXED_WRITE_FIELD(*this, kTagOffset, value);
...
template <class D, class P>
Object TorqueGeneratedTemplateInfo<D, P>::serial_number(const Isolate* isolate) const {
  auto value = TaggedField<Object, kSerialNumberOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
void TorqueGeneratedTemplateInfo<D, P>::set_serial_number(Object value, WriteBarrierMode mode) {
  SLOW_DCHECK(value.IsHeapObject() || value.IsSmi());
  RELAXED_WRITE_FIELD(*this, kSerialNumberOffset, value);
...
template <class D, class P>
Object TorqueGeneratedTemplateInfo<D, P>::property_list(const Isolate* isolate) const {
  auto value = TaggedField<Object, kPropertyListOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedTemplateInfo<D, P>::property_accessors(const Isolate* isolate) const {
  auto value = TaggedField<Object, kPropertyAccessorsOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedFunctionTemplateRareData<D, P>::prototype_template(const Isolate* isolate) const {
  auto value = TaggedField<Object, kPrototypeTemplateOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedFunctionTemplateRareData<D, P>::prototype_provider_template(const Isolate* isolate) const {
  auto value = TaggedField<Object, kPrototypeProviderTemplateOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedFunctionTemplateRareData<D, P>::parent_template(const Isolate* isolate) const {
  auto value = TaggedField<Object, kParentTemplateOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedFunctionTemplateRareData<D, P>::named_property_handler(const Isolate* isolate) const {
  auto value = TaggedField<Object, kNamedPropertyHandlerOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedFunctionTemplateRareData<D, P>::indexed_property_handler(const Isolate* isolate) const {
  auto value = TaggedField<Object, kIndexedPropertyHandlerOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedFunctionTemplateRareData<D, P>::instance_template(const Isolate* isolate) const {
  auto value = TaggedField<Object, kInstanceTemplateOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedFunctionTemplateRareData<D, P>::instance_call_handler(const Isolate* isolate) const {
  auto value = TaggedField<Object, kInstanceCallHandlerOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedFunctionTemplateRareData<D, P>::access_check_info(const Isolate* isolate) const {
  auto value = TaggedField<Object, kAccessCheckInfoOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedFunctionTemplateInfo<D, P>::call_code(const Isolate* isolate) const {
  auto value = TaggedField<Object, kCallCodeOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedFunctionTemplateInfo<D, P>::class_name(const Isolate* isolate) const {
  auto value = TaggedField<Object, kClassNameOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedFunctionTemplateInfo<D, P>::signature(const Isolate* isolate) const {
  auto value = TaggedField<Object, kSignatureOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedFunctionTemplateInfo<D, P>::shared_function_info(const Isolate* isolate) const {
  auto value = TaggedField<Object, kSharedFunctionInfoOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedObjectTemplateInfo<D, P>::constructor(const Isolate* isolate) const {
  auto value = TaggedField<Object, kConstructorOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
...
template <class D, class P>
Object TorqueGeneratedObjectTemplateInfo<D, P>::data(const Isolate* isolate) const {
  auto value = TaggedField<Object, kDataOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
