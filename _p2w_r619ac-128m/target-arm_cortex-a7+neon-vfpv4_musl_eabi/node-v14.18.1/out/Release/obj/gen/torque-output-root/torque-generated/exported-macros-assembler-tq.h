...
class V8_EXPORT_PRIVATE TorqueGeneratedExportedMacrosAssembler {
 public:
  ...
  void CollectCallFeedback(TNode<Object> p_maybeTarget, TNode<Context> p_context, TNode<HeapObject> p_maybeFeedbackVector, TNode<UintPtrT> p_slotId);
  ...
  TNode<Context> CreatePromiseResolvingFunctionsContext(TNode<Context> p_context, TNode<JSPromise> p_promise, TNode<Object> p_debugEvent, TNode<NativeContext> p_nativeContext);
  ...
  TNode<Object> LoadWeakCellUnregisterToken(TNode<WeakCell> p_o);
  void StoreWeakCellUnregisterToken(TNode<WeakCell> p_o, TNode<Object> p_v);
  ...
  TNode<Smi> LoadWasmValueValueType(TNode<WasmValue> p_o);
  void StoreWasmValueValueType(TNode<WasmValue> p_o, TNode<Smi> p_v);
  TNode<Object> LoadWasmValueBytesOrRef(TNode<WasmValue> p_o);
  void StoreWasmValueBytesOrRef(TNode<WasmValue> p_o, TNode<Object> p_v);
  ...
  TNode<HeapObject> LoadJSAggregateErrorErrors(TNode<JSAggregateError> p_o);
  void StoreJSAggregateErrorErrors(TNode<JSAggregateError> p_o, TNode<HeapObject> p_v);
  ...
  TNode<Uint8T> LoadSmallOrderedNameDictionaryPadding(TNode<SmallOrderedNameDictionary> p_o);
  void StoreSmallOrderedNameDictionaryPadding(TNode<SmallOrderedNameDictionary> p_o, TNode<Uint8T> p_v);
  ...
  TNode<Int8T> LoadSeqOneByteStringChars(TNode<SeqOneByteString> p_o, TNode<IntPtrT> p_i);
  void StoreSeqOneByteStringChars(TNode<SeqOneByteString> p_o, TNode<IntPtrT> p_i, TNode<Int8T> p_v);
  TNode<Uint16T> LoadSeqTwoByteStringChars(TNode<SeqTwoByteString> p_o, TNode<IntPtrT> p_i);
  void StoreSeqTwoByteStringChars(TNode<SeqTwoByteString> p_o, TNode<IntPtrT> p_i, TNode<Uint16T> p_v);
  ...
  TNode<Object> LoadFunctionTemplateRareDataCFunction(TNode<FunctionTemplateRareData> p_o);
  void StoreFunctionTemplateRareDataCFunction(TNode<FunctionTemplateRareData> p_o, TNode<Object> p_v);
  TNode<Object> LoadFunctionTemplateRareDataCSignature(TNode<FunctionTemplateRareData> p_o);
  void StoreFunctionTemplateRareDataCSignature(TNode<FunctionTemplateRareData> p_o, TNode<Object> p_v);
