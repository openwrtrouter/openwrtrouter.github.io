...
template <>
void TorqueGeneratedJSAggregateError<JSAggregateError, JSObject>::JSAggregateErrorVerify(Isolate* isolate) {
  TorqueGeneratedClassVerifiers::JSAggregateErrorVerify(JSAggregateError::cast(*this), isolate);
}
#endif  // VERIFY_HEAP
#ifdef VERIFY_HEAP
