...
// Unset a windgi.h macro that causes conflicts.
#ifdef GetBValue
#undef GetBValue
#endif
...
class TqName : public TqPrimitiveHeapObject {
 public:
  ...
  Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetHashFieldValue(d::MemoryAccessor accessor ) const;
};
...
class TqWasmValue : public TqStruct {
 public:
  inline TqWasmValue(uintptr_t address) : TqStruct(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
  bool IsSuperclassOf(const TqObject* other) const override;
  uintptr_t GetValueTypeAddress() const;
  Value<uintptr_t> GetValueTypeValue(d::MemoryAccessor accessor ) const;
  uintptr_t GetBytesOrRefAddress() const;
  Value<uintptr_t> GetBytesOrRefValue(d::MemoryAccessor accessor ) const;
};
...
class TqJSAggregateError : public TqJSObject {
 public:
  inline TqJSAggregateError(uintptr_t address) : TqJSObject(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
  bool IsSuperclassOf(const TqObject* other) const override;
  uintptr_t GetErrorsAddress() const;
  Value<uintptr_t> GetErrorsValue(d::MemoryAccessor accessor ) const;
};
...
class TqJSArrayBuffer : public TqJSObject {
 public:
  ...
  Value<void* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetExtensionValue(d::MemoryAccessor accessor ) const;
  uintptr_t GetBitFieldAddress() const;
...
class TqJSRegExpResult : public TqJSArray {
 public:
  ...
  uintptr_t GetCachedIndicesOrRegexpAddress() const;
  Value<uintptr_t> GetCachedIndicesOrRegexpValue(d::MemoryAccessor accessor ) const;
...
class TqSmallOrderedNameDictionary : public TqSmallOrderedHashTable {
 public:
  ...
  Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetNumberOfBucketsValue(d::MemoryAccessor accessor ) const;
  uintptr_t GetPaddingAddress() const;
  Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetPaddingValue(d::MemoryAccessor accessor ) const;
  uintptr_t GetDataTableAddress() const;
};
...
class TqSharedFunctionInfo : public TqHeapObject {
 public:
  ...
  Value<int16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetFunctionTokenOffsetValue(d::MemoryAccessor accessor ) const;
...
class TqStackFrameInfo : public TqStruct {
 public:
  ...
  uintptr_t GetWasmFunctionIndexAddress() const;
  Value<uintptr_t> GetWasmFunctionIndexValue(d::MemoryAccessor accessor ) const;
...
class TqFunctionTemplateRareData : public TqStruct {
 public:
  ...
  uintptr_t GetCFunctionAddress() const;
  Value<uintptr_t> GetCFunctionValue(d::MemoryAccessor accessor ) const;
  uintptr_t GetCSignatureAddress() const;
  Value<uintptr_t> GetCSignatureValue(d::MemoryAccessor accessor ) const;
};
...
class TqWasmCapiFunctionData : public TqStruct {
 public:
  ...
  Value<void* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetCallTargetValue(d::MemoryAccessor accessor ) const;
...
class TqWasmIndirectFunctionTable : public TqStruct {
 public:
  ...
  bool IsSuperclassOf(const TqObject* other) const override;
  uintptr_t GetSizeAddress() const;
  Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetSizeValue(d::MemoryAccessor accessor ) const;
  uintptr_t GetSigIdsAddress() const;
  Value<void* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetSigIdsValue(d::MemoryAccessor accessor ) const;
  uintptr_t GetTargetsAddress() const;
  Value<void* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetTargetsValue(d::MemoryAccessor accessor ) const;
...
class TqWasmDebugInfo : public TqStruct {
 public:
  ...
  uintptr_t GetInterpreterReferenceStackAddress() const;
  Value<uintptr_t> GetInterpreterReferenceStackValue(d::MemoryAccessor accessor ) const;
...
class TqWasmStruct : public TqHeapObject {
 public:
  inline TqWasmStruct(uintptr_t address) : TqHeapObject(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
...
class TqWasmArray : public TqHeapObject {
 public:
  inline TqWasmArray(uintptr_t address) : TqHeapObject(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
...
class TqObjectVisitor {
 public:
  ...
  virtual void VisitWasmValue(const TqWasmValue* object) {
    VisitStruct(object);
  }
  ...
  virtual void VisitJSAggregateError(const TqJSAggregateError* object) {
    VisitJSObject(object);
  }
