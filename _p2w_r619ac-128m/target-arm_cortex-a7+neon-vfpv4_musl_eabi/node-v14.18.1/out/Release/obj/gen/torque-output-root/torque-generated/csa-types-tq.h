...
struct TorqueStructParameterMapIterator_0 {
  ...
  TNode<IntPtrT> currentMapSlot;

  std::tuple<TNode<Context>, TNode<FixedArray>, TNode<IntPtrT>, TNode<IntPtrT>, TNode<IntPtrT>> Flatten() const {
    return std::tuple_cat(std::make_tuple(context), std::make_tuple(elements), std::make_tuple(currentIndex), std::make_tuple(endInterationIndex), std::make_tuple(currentMapSlot));
  }
};
...
struct TorqueStructReference_Context_OR_Undefined_OR_Zero_0 {
  TNode<HeapObject> object;
  TNode<IntPtrT> offset;
  TorqueStructUnsafe_0 unsafeMarker;
...
struct TorqueStructReference_SmiTagged_WasmGlobalObjectFlags_0 {
  TNode<HeapObject> object;
  TNode<IntPtrT> offset;
  TorqueStructUnsafe_0 unsafeMarker;
