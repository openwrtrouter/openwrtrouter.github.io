...
$(OBJS): | $(obj).host/tools/v8_gypfiles/v8_version.stamp


### Rules for final target.
$(obj).host/tools/v8_gypfiles/v8_headers.stamp: TOOLSET := $(TOOLSET)
$(obj).host/tools/v8_gypfiles/v8_headers.stamp: $(obj).host/tools/v8_gypfiles/v8_version.stamp FORCE_DO_CMD
	$(call do_cmd,touch)

all_deps += $(obj).host/tools/v8_gypfiles/v8_headers.stamp
# Add target alias
.PHONY: v8_headers
v8_headers: $(obj).host/tools/v8_gypfiles/v8_headers.stamp
