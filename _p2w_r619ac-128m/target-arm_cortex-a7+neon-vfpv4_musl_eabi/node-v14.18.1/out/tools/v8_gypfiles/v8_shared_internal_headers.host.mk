...
$(obj).host/tools/v8_gypfiles/v8_shared_internal_headers.stamp: TOOLSET := $(TOOLSET)
$(obj).host/tools/v8_gypfiles/v8_shared_internal_headers.stamp: $(obj).host/tools/v8_gypfiles/v8_headers.stamp FORCE_DO_CMD
	$(call do_cmd,touch)

all_deps += $(obj).host/tools/v8_gypfiles/v8_shared_internal_headers.stamp
# Add target alias
.PHONY: v8_shared_internal_headers
v8_shared_internal_headers: $(obj).host/tools/v8_gypfiles/v8_shared_internal_headers.stamp
