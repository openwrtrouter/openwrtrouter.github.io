...
OBJS := \
	$(obj).host/$(TARGET)/deps/v8/src/torque/ls/json-parser.o \
	$(obj).host/$(TARGET)/deps/v8/src/torque/ls/json.o \
	$(obj).host/$(TARGET)/deps/v8/src/torque/ls/message-handler.o
...
$(obj).host/tools/v8_gypfiles/libtorque_ls_base.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).host/tools/v8_gypfiles/libtorque_ls_base.a: LIBS := $(LIBS)
$(obj).host/tools/v8_gypfiles/libtorque_ls_base.a: TOOLSET := $(TOOLSET)
$(obj).host/tools/v8_gypfiles/libtorque_ls_base.a: $(OBJS)
	$(call create_thin_archive,$@,$^)

# Add target alias
.PHONY: torque_ls_base
torque_ls_base: $(obj).host/tools/v8_gypfiles/libtorque_ls_base.a
