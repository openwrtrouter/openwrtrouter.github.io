...
$(obj).host/tools/v8_gypfiles/torque_generated_initializers.stamp: TOOLSET := $(TOOLSET)
$(obj).host/tools/v8_gypfiles/torque_generated_initializers.stamp: $(obj).host/tools/v8_gypfiles/generate_bytecode_builtins_list.stamp $(obj).host/tools/v8_gypfiles/run_torque.stamp $(obj).host/tools/v8_gypfiles/v8_maybe_icu.stamp FORCE_DO_CMD
	$(call do_cmd,touch)

all_deps += $(obj).host/tools/v8_gypfiles/torque_generated_initializers.stamp
# Add target alias
.PHONY: torque_generated_initializers
torque_generated_initializers: $(obj).host/tools/v8_gypfiles/torque_generated_initializers.stamp
