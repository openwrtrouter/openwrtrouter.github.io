...
OBJS := \
	$(obj).host/$(TARGET)/deps/v8/src/regexp/gen-regexp-special-case.o

# Add to the list of files we specially track dependencies for.
all_deps += $(OBJS)

# Make sure our dependencies are built before any of us.
$(OBJS): | $(obj).host/tools/v8_gypfiles/libv8_libbase.a $(obj).host/tools/v8_gypfiles/v8_maybe_icu.stamp $(obj).host/tools/v8_gypfiles/v8_headers.stamp $(obj).host/tools/v8_gypfiles/v8_version.stamp
...
$(builddir)/gen-regexp-special-case: LD_INPUTS := $(OBJS) $(obj).host/tools/v8_gypfiles/libv8_libbase.a
$(builddir)/gen-regexp-special-case: TOOLSET := $(TOOLSET)
$(builddir)/gen-regexp-special-case: $(OBJS) $(obj).host/tools/v8_gypfiles/libv8_libbase.a FORCE_DO_CMD
	$(call do_cmd,link)
