...
OBJS := \
	...
	$(obj).host/$(TARGET)/deps/v8/src/base/bounded-page-allocator.o \
...
$(OBJS): | $(obj).host/tools/v8_gypfiles/v8_headers.stamp
...
$(obj).host/tools/v8_gypfiles/libv8_libbase.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).host/tools/v8_gypfiles/libv8_libbase.a: LIBS := $(LIBS)
$(obj).host/tools/v8_gypfiles/libv8_libbase.a: TOOLSET := $(TOOLSET)
$(obj).host/tools/v8_gypfiles/libv8_libbase.a: $(OBJS)
	$(call create_thin_archive,$@,$^)

# Add target alias
.PHONY: v8_libbase
v8_libbase: $(obj).host/tools/v8_gypfiles/libv8_libbase.a
