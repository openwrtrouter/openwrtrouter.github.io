...
OBJS := \
	$(obj).host/$(TARGET)/deps/v8/src/init/setup-isolate-full.o
...
$(obj).host/tools/v8_gypfiles/libv8_init.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).host/tools/v8_gypfiles/libv8_init.a: LIBS := $(LIBS)
$(obj).host/tools/v8_gypfiles/libv8_init.a: TOOLSET := $(TOOLSET)
$(obj).host/tools/v8_gypfiles/libv8_init.a: $(OBJS)
	$(call create_thin_archive,$@,$^)

# Add target alias
.PHONY: v8_init
v8_init: $(obj).host/tools/v8_gypfiles/libv8_init.a
