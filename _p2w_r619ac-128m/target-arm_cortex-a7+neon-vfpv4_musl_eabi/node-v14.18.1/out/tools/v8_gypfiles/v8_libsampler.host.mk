...
$(obj).host/tools/v8_gypfiles/libv8_libsampler.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).host/tools/v8_gypfiles/libv8_libsampler.a: LIBS := $(LIBS)
$(obj).host/tools/v8_gypfiles/libv8_libsampler.a: TOOLSET := $(TOOLSET)
$(obj).host/tools/v8_gypfiles/libv8_libsampler.a: $(OBJS)
	$(call create_thin_archive,$@,$^)

# Add target alias
.PHONY: v8_libsampler
v8_libsampler: $(obj).host/tools/v8_gypfiles/libv8_libsampler.a
